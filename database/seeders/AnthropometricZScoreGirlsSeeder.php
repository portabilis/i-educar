...
class AnthropometricZScoreGirlsSeeder extends XlsxSeeder
{
    ...
    public function run()
    {
        $this->command->info('Carregando dados LMS para meninas (girls)...');
        ...
        $this->command->info("{$count} registros de meninas carregados com sucesso!");
    }
}
