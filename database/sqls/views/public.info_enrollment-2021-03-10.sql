...
select
    ...
    matricula.aprovado IN (1, 2, 12, 13, 14) AS registration_next,
    matricula.aprovado IN (1, 12, 13) AS registration_approved,
    matricula.aprovado IN (2, 14) AS registration_reproved,
