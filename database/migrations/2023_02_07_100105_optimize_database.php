...
return new class () extends Migration {
    ...
    public function down()
    {
        ...
        \DB::statement('ALTER TABLE pmieducar.ano_letivo_modulo DROP CONSTRAINT IF EXISTS pmieducar_ano_letivo_modulo_ref_ref_cod_escola_ref_ano_foreign');
        \DB::statement('ALTER TABLE pmieducar.ano_letivo_modulo DROP CONSTRAINT IF EXISTS ano_letivo_modulo_ref_ref_cod_escola_fkey');
        \DB::statement('ALTER TABLE pmieducar.ano_letivo_modulo DROP CONSTRAINT IF EXISTS ano_letivo_modulo_ref_ano_ref_ref_cod_escola_sequencial_ref_cod');
        \DB::statement('ALTER TABLE pmieducar.ano_letivo_modulo DROP CONSTRAINT IF EXISTS ano_letivo_modulo_ref_ref_cod_escola_foreign');
        ...
        //MODULO
        \DB::statement('ALTER TABLE pmieducar.modulo ALTER COLUMN cod_modulo type integer USING cod_modulo::integer');
        ...
        \DB::statement('ALTER TABLE pmieducar.escola_ano_letivo drop constraint if exists escola_ano_letivo_ref_cod_escola_ano_unique cascade');
        \DB::statement('DROP INDEX IF EXISTS escola_ano_letivo_ref_cod_escola_ano_unique cascade ');
        \DB::statement('ALTER TABLE pmieducar.escola_ano_letivo DROP CONSTRAINT IF EXISTS escola_ano_letivo_pkey');
        Schema::table('escola_ano_letivo', function (Blueprint $table) {
            $table->dropColumn('id');
        ...
        //ANO LETIVO MODULO
        \DB::statement('ALTER TABLE pmieducar.ano_letivo_modulo ADD CONSTRAINT pmieducar_ano_letivo_modulo_ref_ref_cod_escola_ref_ano_foreign FOREIGN KEY (ref_ref_cod_escola, ref_ano) REFERENCES pmieducar.escola_ano_letivo(ref_cod_escola, ano) ON DELETE CASCADE');
    }
};
