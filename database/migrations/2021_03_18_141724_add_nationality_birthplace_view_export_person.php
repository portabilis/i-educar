...
class AddNationalityBirthplaceViewExportPerson extends Migration
{
    use AsView;
    ...
    {
        $this->createView('public.exporter_person', '2020-04-16');
        $this->createView('public.exporter_student', '2020-05-14_v2');
        $this->createView('public.exporter_social_assistance', '2020-05-07');
        $this->createView('public.exporter_teacher', '2020-04-07');
    }
}
