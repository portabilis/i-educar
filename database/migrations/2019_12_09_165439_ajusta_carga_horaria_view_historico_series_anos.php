...
class AjustaCargaHorariaViewHistoricoSeriesAnos extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        $sql = <<<'SQL'
            CREATE OR REPLACE VIEW relatorio.view_historico_series_anos AS 
                SELECT
                    ...
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '1'::text) || '-carga_horaria'::text))::numeric AS carga_horaria1,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '2'::text) || '-carga_horaria'::text))::numeric AS carga_horaria2,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '3'::text) || '-carga_horaria'::text))::numeric AS carga_horaria3,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '4'::text) || '-carga_horaria'::text))::numeric AS carga_horaria4,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '5'::text) || '-carga_horaria'::text))::numeric AS carga_horaria5,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '6'::text) || '-carga_horaria'::text))::numeric AS carga_horaria6,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '7'::text) || '-carga_horaria'::text))::numeric AS carga_horaria7,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '8'::text) || '-carga_horaria'::text))::numeric AS carga_horaria8,
                    (historico_por_disciplina.carga_horaria OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '9'::text) || '-carga_horaria'::text))::numeric AS carga_horaria9,
                    ...
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '1'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina1,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '2'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina2,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '3'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina3,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '4'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina4,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '5'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina5,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '6'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina6,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '7'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina7,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '8'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina8,
                    (historico_por_disciplina.carga_horaria_disciplina OPERATOR(relatorio.->) (((historico_disciplinas.disciplina || '-'::text) || '9'::text) || '-carga_horaria_disciplina'::text))::numeric AS carga_horaria_disciplina9,
                        ...
                        SELECT
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-escola_cidade'::text AS escola_cidade_key,
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-escola_uf'::text AS escola_uf_key,
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-carga_horaria'::text AS carga_horaria_key,
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-frequencia'::text AS frequencia_key,
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-carga_horaria_disciplina'::text AS carga_horaria_disciplina_key,
                            ...
                            (
                                ...
                                CASE
                                    ...
                                    ELSE ("substring"(historico_escolar_1.nm_serie::text, 1, 1)::integer + 1)::text
                                END
                            ) || '-dependencia'::text AS dependencia_key,
