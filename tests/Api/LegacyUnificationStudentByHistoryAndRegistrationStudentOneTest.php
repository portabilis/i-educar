...
class LegacyUnificationStudentByHistoryAndRegistrationStudentOneTest extends TestCase
{
    ...
    public function test_unification_by_history_and_registration_student_one(): void
    {
