...
class DifferentiatedLocationValidatorTest extends TestCase
{
    public function testDifferentiatedLocationIsAreaAssentamentoAndLocationZoneIsUrbana()
    {
        ...
        $this->assertContains('O campo: Localização diferenciada não pode ser preenchido com Área de assentamento quando o campo: Zona de residência for Urbana.', $validator->getMessage());
    }
