...
class EducacensoExportController extends ApiCoreController
{
  ...
  protected function exportaDadosRegistro00($escolaId, $ano){
    $sql =
      ...
      e.situacao_funcionamento as r00s7,
        ...
        ARRAY[1] <@ e.mantenedora_escola_privada as r00s32,
        ARRAY[2] <@ e.mantenedora_escola_privada as r00s33,
        ARRAY[3] <@ e.mantenedora_escola_privada as r00s34,
        ARRAY[4] <@ e.mantenedora_escola_privada as r00s35,
        ARRAY[5] <@ e.mantenedora_escola_privada as r00s36,
  ...
  protected function exportaDadosRegistro10($escolaId, $ano){
    $sql =
      ...
      ARRAY[1] <@ e.abastecimento_agua as r10s21,
      ARRAY[2] <@ e.abastecimento_agua as r10s22,
      ARRAY[3] <@ e.abastecimento_agua as r10s23,
      ARRAY[4] <@ e.abastecimento_agua as r10s24,
      ARRAY[5] <@ e.abastecimento_agua as r10s25,
      ARRAY[1] <@ e.abastecimento_energia as r10s26,
      ARRAY[2] <@ e.abastecimento_energia as r10s27,
      ARRAY[3] <@ e.abastecimento_energia as r10s28,
      ARRAY[4] <@ e.abastecimento_energia as r10s29,
      ARRAY[1] <@ e.esgoto_sanitario as r10s30,
      ARRAY[2] <@ e.esgoto_sanitario as r10s31,
      ARRAY[3] <@ e.esgoto_sanitario as r10s32,
      ARRAY[1] <@ e.destinacao_lixo as r10s33,
      ARRAY[2] <@ e.destinacao_lixo as r10s34,
      ARRAY[3] <@ e.destinacao_lixo as r10s35,
      ARRAY[4] <@ e.destinacao_lixo as r10s36,
      ARRAY[5] <@ e.destinacao_lixo as r10s37,
      ARRAY[6] <@ e.destinacao_lixo as r10s38,
  ...
  protected function exportaDadosRegistro20($escolaId, $turmaId, $data_ini, $data_fim){
    $sql =
        ...
        ARRAY[1] <@ t.dias_semana as r20s11,
        ARRAY[2] <@ t.dias_semana as r20s12,
        ARRAY[3] <@ t.dias_semana as r20s13,
        ARRAY[4] <@ t.dias_semana as r20s14,
        ARRAY[5] <@ t.dias_semana as r20s15,
        ARRAY[6] <@ t.dias_semana as r20s16,
        ARRAY[7] <@ t.dias_semana as r20s17,
        ...
        ARRAY[1] <@ t.atividades_aee as r20s26,
        ARRAY[2] <@ t.atividades_aee as r20s27,
        ARRAY[3] <@ t.atividades_aee as r20s28,
        ARRAY[4] <@ t.atividades_aee as r20s29,
        ARRAY[5] <@ t.atividades_aee as r20s30,
        ARRAY[6] <@ t.atividades_aee as r20s31,
        ARRAY[7] <@ t.atividades_aee as r20s32,
        ARRAY[8] <@ t.atividades_aee as r20s33,
        ARRAY[9] <@ t.atividades_aee as r20s34,
        ARRAY[10] <@ t.atividades_aee as r20s35,
        ARRAY[11] <@ t.atividades_aee as r20s36,
