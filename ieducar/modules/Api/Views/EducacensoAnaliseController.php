...
class EducacensoAnaliseController extends ApiCoreController
{
  ...
  protected function analisaEducacensoRegistro00() {
    ...
    if ($escola['dependencia_administrativa'] == 4 && $escola['situacao_funcionamento'] == 1) {
      ...
      if (!$escola["categoria_escola_privada"]) {
          $mensagem[] = array("text" => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual a categoria desta unidade escolar.",
      ...
      if (!$escola["conveniada_com_poder_publico"]) {
          $mensagem[] = array("text" => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual o tipo de convênio desta unidade escolar.",
      ...
      if (!$escola["mantenedora_escola_privada"]) {
          $mensagem[] = array("text" => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual o tipo de mantenedora desta unidade escolar.",
      ...
      if (!$escola["cnpj_mantenedora_principal"]) {
          $mensagem[] = array("text" => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar o CNPJ da mantenedora principal desta unidade escolar.",
  ...
  protected function analisaEducacensoRegistro10() {
    ...
    $sql = "SELECT escola.local_funcionamento AS local_funcionamento,
                   ...
                   ARRAY[1] <@ escola.abastecimento_agua AS agua_rede_publica,
                   ARRAY[2] <@ escola.abastecimento_agua AS agua_poco_artesiano,
                   ARRAY[3] <@ escola.abastecimento_agua AS agua_cacimba_cisterna_poco,
                   ARRAY[4] <@ escola.abastecimento_agua AS agua_fonte_rio,
                   ARRAY[5] <@ escola.abastecimento_agua AS agua_inexistente,
                   ARRAY[1] <@ escola.abastecimento_energia AS energia_rede_publica,
                   ARRAY[2] <@ escola.abastecimento_energia AS energia_gerador,
                   ARRAY[3] <@ escola.abastecimento_energia AS energia_outros,
                   ARRAY[4] <@ escola.abastecimento_energia AS energia_inexistente,
                   ARRAY[1] <@ escola.esgoto_sanitario AS esgoto_rede_publica,
                   ARRAY[2] <@ escola.esgoto_sanitario AS esgoto_fossa,
                   ARRAY[3] <@ escola.esgoto_sanitario AS esgoto_inexistente,
                   ARRAY[1] <@ escola.destinacao_lixo AS lixo_coleta_periodica,
                   ARRAY[2] <@ escola.destinacao_lixo AS lixo_queima,
                   ARRAY[3] <@ escola.destinacao_lixo AS lixo_joga_outra_area,
                   ARRAY[4] <@ escola.destinacao_lixo AS lixo_recicla,
                   ARRAY[5] <@ escola.destinacao_lixo AS lixo_enterra,
                   ARRAY[6] <@ escola.destinacao_lixo AS lixo_outros,
