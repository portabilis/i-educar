...
class EducacensoAnaliseController extends ApiCoreController
{
    protected function analisaEducacensoRegistro00()
    {
        ...
        if (empty($escola)) {
            ...
            return ['title' => 'Análise exportação - Registro 00'];
        }
        ...
        if (!$escola['inep']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se a escola possui o código INEP cadastrado.",
        ...
        if (!$escola['nome_gestor_escolar']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o(a) gestor(a) escolar foi informado(a).",
        ...
        if (!$escola['cpf_gestor_escolar'] && $escola['nome_gestor_escolar']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o(a) gestor(a) escolar possui o CPF cadastrado.",
        ...
        if (!$escola['email_gestor_escolar'] || empty($escola['email_gestor_escolar'])) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o e-mail do(a) gestor(a) escolar foi informado.",
        ...
        if (!$escola['cargo_gestor_escolar']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o cargo do(a) gestor(a) escolar foi informado.",
        ...
        if ($escola['data_inicio'] != $anoAtual && $escola['data_inicio'] != $anoAnterior) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} possui valor inválido. Verifique se a data inicial da primeira etapa foi cadastrada corretamente.",
        ...
        if ($escola['data_fim'] != $anoAtual && $escola['data_fim'] != $anoPosterior) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} possui valor inválido. Verifique se a data final da última etapa foi cadastrada corretamente.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar ano letivo > Ok > Campo: Data final)',
                          'linkPath' => "/intranet/educar_ano_letivo_modulo_cad.php?ref_cod_escola={$codEscola}&ano={$anoAtual}",
                          'fail' => true];
        }
        if ((!$escola['latitude']) && $escola['longitude']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a longitude foi informada, portanto obrigatoriamente a latitude também deve ser informada.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Dados gerais > Campo: Latitude)',
                          'linkPath' => "/intranet/educar_escola_cad.php?cod_escola={$codEscola}",
                          'fail' => true];
        }
        if ((!$escola['longitude']) && $escola['latitude']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a latitude foi informada, portanto obrigatoriamente a longitude também deve ser informada.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Dados gerais > Campo: Longitude)',
                          'linkPath' => "/intranet/educar_escola_cad.php?cod_escola={$codEscola}",
                          'fail' => true];
        }
        if (!$escola['inep_uf']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o código da UF informada, foi cadastrado conforme a 'Tabela de UF'.",
        ...
        if (!$escola['inep_municipio']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o código do município informado, foi cadastrado conforme a 'Tabela de Municípios'.",
        ...
        if (!$escola['inep_distrito']) {
            $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verifique se o código do distrito informado, foi cadastrado conforme a 'Tabela de Distritos'.",
        ...
        if ($escola['dependencia_administrativa'] == 4 && $escola['situacao_funcionamento'] == 1) {
            if (!$escola['categoria_escola_privada']) {
                $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual a categoria desta unidade escolar.",
            ...
            if (!$escola['conveniada_com_poder_publico']) {
                $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual o tipo de convênio desta unidade escolar.",
            ...
            if (!$escola['mantenedora_escola_privada']) {
                $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar qual o tipo de mantenedora desta unidade escolar.",
            ...
            if (!$escola['cnpj_mantenedora_principal']) {
                $mensagem[] = ['text' => "Dados para formular o registro 00 da escola {$nomeEscola} não encontrados. Verificamos que a dependência administrativa da escola é privada, portanto é necessário informar o CNPJ da mantenedora principal desta unidade escolar.",
    ...
    protected function analisaEducacensoRegistro10()
    {
        ...
        if (empty($escola)) {
            ...
            return ['title' => 'Análise exportação - Registro 10'];
        }
        ...
        if (!$escola['local_funcionamento']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se o local de funcionamento da escola foi informado.",
        ...
        if ($escola['local_funcionamento'] == $predioEscolar && !$escola['condicao']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verificamos que o local de funcionamento da escola é em um prédio escolar, portanto obrigatoriamente é necessário informar qual a forma de ocupação do prédio.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Infraestrutura > Campo: Condição)',
                          'linkPath' => "/intranet/educar_escola_cad.php?cod_escola={$codEscola}",
                          'fail' => true];
        }
        if (!$escola['agua_consumida']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se a água consumida pelos alunos foi informada.",
        ...
        if (!$existeAbastecimentoAgua) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se uma das formas do abastecimento de água foi informada.",
        ...
        if (!$existeAbastecimentoEnergia) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se uma das formas do abastecimento de energia elétrica foi informada.",
        ...
        if (!$existeEsgotoSanitario) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se alguma opção de esgoto sanitário foi informada.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Infraestrutura > Campos: Esgoto sanitário)',
                          'linkPath' => "/intranet/educar_escola_cad.php?cod_escola={$codEscola}",
                          'fail' => true];
        }
        if (!$existeDestinacaoLixo) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se uma das formas da destinação do lixo foi informada.",
                          'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Infraestrutura > Campos: Destinação do lixo)',
                          'linkPath' => "/intranet/educar_escola_cad.php?cod_escola={$codEscola}",
                          'fail' => true];
        }
        if (!$existeDependencia) {
            $mensagem[] = ['text' => "<span class='avisos-educacenso'><b>Aviso!</b> Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Nenhum campo foi preenchido referente as dependências existentes na escola, portanto todos serão registrados como NÃO.</span>",
        ...
        if ($escola['local_funcionamento'] == $predioEscolar && !$escola['dependencia_numero_salas_existente']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verificamos que o local de funcionamento da escola é em um prédio escolar, portanto obrigatoriamente é necessário informar o número de salas de aula existentes na escola.",
        ...
        if (!$escola['dependencia_numero_salas_utilizadas']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se o número de salas utilizadas como sala de aula foi informado.",
        ...
        if (!$existeEquipamentos) {
            $mensagem[] = ['text' => "<span class='avisos-educacenso'><b>Aviso!</b> Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Nenhum campo foi preenchido referente a quantidade de equipamentos existentes na escola, portanto todos serão registrados como NÃO.</span>",
        ...
        if (!$escola['total_funcionario']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se o total de funcionários da escola foi informado.",
        ...
        if ($escola['atendimento_aee'] < 0) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se o atendimento educacional especializado - AEE foi informado.",
        ...
        if ($escola['atividade_complementar'] < 0) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se a atividade complementar foi informada.",
        ...
        if (!$escola['localizacao_diferenciada']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se a localização diferenciada da escola foi informada.",
        ...
        if (!$existeMaterialDidatico) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verifique se algum material didático específico para atendimento à diversidade sócio-cultural foi informado.",
        ...
        if ($escola['educacao_indigena'] && !$escola['lingua_ministrada']) {
            $mensagem[] = ['text' => "Dados para formular o registro 10 da escola {$nomeEscola} não encontrados. Verificamos que a escola trabalha com educação indígena, portanto obrigatoriamente é necessário informar a língua em que o ensino é ministrado.",
        ...
        case 3:
          ...
          break;
            ...
            if (!$turma['hora_inicial']) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verifique se o horário inicial da turma {$nomeTurma} foi cadastrado.",
            ...
            if (!$turma['hora_final']) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verifique se o horário final da turma {$nomeTurma} foi cadastrado.",
                            'path' => '(Escola > Cadastros > Turmas > Cadastrar > Editar > Aba: Dados gerais > Campo: Hora final)',
                            'linkPath' => "/intranet/educar_turma_cad.php?cod_turma={$codTurma}",
                            'fail' => true];
            }
            if (!$turma['dias_semana']) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. É necessário informar ao menos um dia da semana para a turma presencial {$nomeTurma}.",
            ...
            if (is_null($turma['tipo_atendimento']) || $turma['tipo_atendimento'] < 0) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verifique se o tipo de atendimento da turma {$nomeTurma} foi cadastrado.",
            ...
            if (!$atendimentoAee && !$atividadeComplementar && !$turma['etapa_educacenso']) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verificamos que o tipo de atendimento da turma {$nomeTurma} é '{$nomeAtendimento}', portanto é necessário informar qual a etapa de ensino.",
            ...
            if ($atividadeComplementar && !$existeAtividadeComplementar) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verificamos que o tipo de atendimento da turma {$nomeTurma} é de atividade complementar, portanto obrigatoriamente é necessário informar o código de ao menos uma atividade.",
            ...
            if ($atendimentoAee && !$existeAee) {
                $mensagem[] = ['text' => "Dados para formular o registro 20 da escola {$nomeEscola} não encontrados. Verificamos que o tipo de atendimento da turma {$nomeTurma} é de educação especializada - AEE, portanto obrigatoriamente é necessário informar ao menos uma atividade realizada. ",
    ...
    protected function analisaEducacensoRegistro30()
    {
        ...
        foreach ($servidores as $servidor) {
            ...
            if (is_null($servidor['cor_raca'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verifique se a raça do(a) servidor(a) {$nomeServidor} foi informada.",
            ...
            if (!$servidor['nacionalidade']) {
                $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verifique se a nacionalidade do(a) servidor(a) {$nomeServidor} foi informada.",
                ...
                if ($servidor['nacionalidade'] == $brasileiro && !$servidor['uf_inep']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verificamos que a nacionalidade do(a) servidor(a) {$nomeServidor} é brasileiro(a), portanto é necessário preencher o código da UF de nascimento conforme a 'Tabela de UF'.",
                              'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                              'linkPath' => "/intranet/public_uf_cad.php?sigla_uf={$siglaUF}",
                              'fail' => true];
                }
                if ($servidor['nacionalidade'] == $brasileiro && !$servidor['municipio_inep']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verificamos que a nacionalidade do(a) servidor(a) {$nomeServidor} é brasileiro(a), portanto é necessário preencher o código do município de nascimento conforme a 'Tabela de Municípios'.",
                              'path' => '(Endereçamento > Cadastros > Municípios > Editar > Campo: Código INEP)',
                              'linkPath' => "/intranet/public_municipio_cad.php?idmun={$codMunicipio}",
                              'fail' => true];
                }
    ...
    protected function analisaEducacensoRegistro40()
    {
        ...
        foreach ($servidores as $servidor) {
            ...
            if ($naturalidadeBrasileiro && !$servidor['cpf']) {
                $mensagem[] = ['text' => "Dados para formular o registro 40 da escola {$nomeEscola} não encontrados. Verificamos que a nacionalidade do(a) servidor(a) {$nomeServidor} é brasileiro(a)/naturalizado brasileiro(a), portanto é necessário informar seu CPF.",
                            'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: CPF)',
                            'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$idpesServidor}",
                            'fail' => true];
            }
            if ($servidor['cep'] && !$servidor['uf_inep']) {
                $mensagem[] = ['text' => "Dados para formular o registro 40 da escola {$nomeEscola} não encontrados. Verificamos que no cadastro do(a) servidor(a) {$nomeServidor} o endereçamento foi informado, portanto é necessário cadastrar código da UF informada conforme a 'Tabela de UF'.",
                            'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                            'linkPath' => "/intranet/public_uf_cad.php?sigla_uf={$siglaUF}",
                            'fail' => true];
            }
            if ($servidor['cep'] && !$servidor['municipio_inep']) {
                $mensagem[] = ['text' => "Dados para formular o registro 40 da escola {$nomeEscola} não encontrados. Verificamos que no cadastro do(a) servidor(a) {$nomeServidor} o endereçamento foi informado, portanto é necessário cadastrar código do município informado conforme a 'Tabela de Municípios'.",
                            'path' => '(Endereçamento > Cadastros > Municípios > Editar > Campo: Código INEP)',
                            'linkPath' => "/intranet/public_municipio_cad.php?idmun={$codMunicipio}",
                            'fail' => true];
            }
    ...
    protected function analisaEducacensoRegistro50()
    {
        ...
        foreach ($servidores as $servidor) {
            ...
            if (!$servidor['codigo_escolaridade']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verifique se a escolaridade do(a) servidor(a) {$nomeServidor} foi informada.",
            ...
            if ($servidor['codigo_escolaridade'] && !$servidor['escolaridade']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verifique se o campo escolaridade educacenso foi informado para a escolaridade {$servidor['descricao_escolaridade']}.",
            ...
            if ($servidor['escolaridade'] == $superiorCompleto && !$servidor['situacao_curso_superior_1']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a escolaridade do(a) servidor(a) {$nomeServidor} é superior, portanto é necessário informar a situação do curso superior 1.",
            ...
            if ($servidor['situacao_curso_superior_1'] && !$servidor['codigo_curso_superior_1']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a escolaridade do(a) servidor(a) {$nomeServidor} é superior, portanto é necessário informar o nome do curso superior 1.",
            ...
            if ($servidor['situacao_curso_superior_1'] == $situacaoCursando && !$servidor['ano_inicio_curso_superior_1']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} está cursando um curso superior, portanto é necessário informar o ano de início deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_1'] == $situacaoConcluido && !$servidor['ano_conclusao_curso_superior_1']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} concluiu um curso superior, portanto é necessário informar o ano de conclusão deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_1'] && !$servidor['instituicao_curso_superior_1']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a escolaridade do(a) servidor(a) {$nomeServidor} é superior, portanto é necessário informar o nome da instituição do curso superior 1.",
            ...
            if ($servidor['situacao_curso_superior_2'] && !$servidor['codigo_curso_superior_2']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a situação do curso superior 2 do(a) servidor(a) {$nomeServidor} foi informada, portanto é necessário informar o nome do curso superior 2.",
            ...
            if ($servidor['situacao_curso_superior_2'] == $situacaoCursando && !$servidor['ano_inicio_curso_superior_2']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} está cursando um curso superior 2, portanto é necessário informar o ano de início deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_2'] == $situacaoConcluido && !$servidor['ano_conclusao_curso_superior_2']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} concluiu um curso superior 2, portanto é necessário informar o ano de conclusão deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_2'] && !$servidor['instituicao_curso_superior_2']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a situação do curso superior 2 do(a) servidor(a) {$nomeServidor} foi informada, portanto é necessário informar também o nome da instituição deste respectivo curso. ",
            ...
            if ($servidor['situacao_curso_superior_3'] && !$servidor['codigo_curso_superior_3']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a situação do curso superior 3 do(a) servidor(a) {$nomeServidor} foi informada, portanto é necessário informar o nome do curso superior 3.",
            ...
            if ($servidor['situacao_curso_superior_3'] == $situacaoCursando && !$servidor['ano_inicio_curso_superior_3']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} está cursando um curso superior 3, portanto é necessário informar o ano de início deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_3'] == $situacaoConcluido && !$servidor['ano_conclusao_curso_superior_3']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} concluiu um curso superior 3, portanto é necessário informar o ano de conclusão deste respectivo curso.",
            ...
            if ($servidor['situacao_curso_superior_3'] && !$servidor['instituicao_curso_superior_3']) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verificamos que a situação do curso superior 3 do(a) servidor(a) {$nomeServidor} foi informada, portanto é necessário informar também o nome da instituição deste respectivo curso. ",
            ...
            if ($existeCursoConcluido && !$existePosGraduacao) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verifique se alguma das opções de Pós-Graduação foi informada para o(a) servidor(a) {$nomeServidor}.",
            ...
            if (!$existeCursoFormacaoContinuada) {
                $mensagem[] = ['text' => "Dados para formular o registro 50 da escola {$nomeEscola} não encontrados. Verifique se alguma das opções de Curso de Formação Continuada foi informada para o(a) servidor(a) {$nomeServidor}.",
    ...
    protected function analisaEducacensoRegistro51()
    {
        ...
        foreach ($servidores as $servidor) {
            ...
            if ($funcaoDocente && !$servidor['tipo_vinculo']) {
                $mensagem[] = ['text' => "Dados para formular o registro 51 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} é docente e possui vínculo com turmas, portanto é necessário informar qual o seu tipo de vínculo.",
            ...
            if ($componenteNaoExisteNaTurma) {
                $mensagem[] = ['text' => "Dados para formular o registro 51 da escola {$nomeEscola} não encontrados. Verificamos que o(a) servidor(a) {$nomeServidor} possui vínculo com disciplina que não existe para a turma {$nomeTurma}",
                            'path' => '(Servidores > Cadastros > Servidores > Cadastrar > Vincular professor a turmas > Campo: Tipo do vínculo)',
                            'linkPath' => "/intranet/educar_servidor_vinculo_turma_cad.php?id={$vinculoId}&ref_cod_instituicao={$instituicaoId}&ref_cod_servidor={$idpesServidor}",
                            'fail' => true];
            }
    ...
    protected function analisaEducacensoRegistro60()
    {
        ...
        foreach ($alunos as $aluno) {
            ...
            if (is_null($aluno['cor_raca'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 60 da escola {$nomeEscola} não encontrados. Verifique se a raça do(a) aluno(a) {$nomeAluno} foi informada.",
                            'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: Raça)',
                            'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$codPessoa}",
                            'fail' => true];
            }
            if (!$aluno['nacionalidade']) {
                $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verifique se a nacionalidade do(a) aluno(a) {$nomeAluno} foi informada.",
                            'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: Nacionalidade)',
                            'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$codPessoa}",
                            'fail' => true];
            } else {
                if ($aluno['nacionalidade'] == $brasileiro && !$aluno['uf_inep']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verificamos que a nacionalidade do(a) aluno(a) {$nomeAluno} é brasileiro(a), portanto é necessário preencher o código da UF de nascimento conforme a 'Tabela de UF'.",
                              'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                              'linkPath' => "/intranet/public_uf_cad.php?sigla_uf={$siglaUF}",
                              'fail' => true];
                }
                if ($aluno['nacionalidade'] == $brasileiro && !$aluno['municipio_inep']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 30 da escola {$nomeEscola} não encontrados. Verificamos que a nacionalidade do(a) aluno(a) {$nomeAluno} é brasileiro(a), portanto é necessário preencher o código do município de nascimento conforme a 'Tabela de Municípios'.",
                              'path' => '(Endereçamento > Cadastros > Municípios > Editar > Campo: Código INEP)',
                              'linkPath' => "/intranet/public_municipio_cad.php?idmun={$codMunicipio}",
                              'fail' => true];
                }
                if (dbBool($aluno['possui_deficiencia']) && empty($aluno['recursos_prova_inep'])) {
                    $mensagem[] = ['text' => "<span class='avisos-educacenso'><b>Aviso!</b> Dados para formular o registro 60 da escola {$nomeEscola} não encontrados. Verificamos que o(a) aluno(a) {$nomeAluno} possui uma(s) deficiência(s), porém nenhum recurso para a prova INEP foi selecionado.</span>",
        ...
        foreach ($alunos as $aluno) {
            ...
            if ($aluno['rg']) {
                if (!$aluno['orgao_emissor_rg']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o número da identidade do(a) aluno(a) {$nomeAluno} foi informada, portanto é necessário informar também o órgão emissor da identidade.",
                ...
                if (!$aluno['sigla_uf_rg']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o número da identidade do(a) aluno(a) {$nomeAluno} foi informada, portanto é necessário informar também o estado da identidade.",
                              'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: RG / Data emissão)',
                              'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$idpesAluno}",
                              'fail' => true];
                }
                if ($aluno['sigla_uf_rg'] && !$aluno['uf_inep_rg']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o estado da identidade do(a) aluno(a) {$nomeAluno} foi informado, portanto é necessário preencher o código deste estado conforme a 'Tabela de UF'.",
                              'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                              'linkPath' => "/intranet/public_uf_cad.php?sigla_uf={$siglaUF}",
                              'fail' => true];
                }
            ...
            if ($certidaoAntigoFormato && $aluno['nacionalidade'] != $estrangeiro) {
                if (!$aluno['num_termo']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o tipo da certidão civil do(a) aluno(a) {$nomeAluno} foi informada, portanto é necessário informar também o número do termo da certidão.",
                              'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: Termo)',
                              'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$idpesAluno}",
                              'fail' => true];
                }
                if (!$aluno['uf_cartorio']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o número do termo da certidão civil do(a) aluno(a) {$nomeAluno} foi informado, portanto é necessário informar também o estado de emissão.",
                ...
                if ($aluno['uf_cartorio'] && !$aluno['uf_inep_cartorio']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o estado do cartório do(a) aluno(a) {$nomeAluno} foi informado, portanto é necessário preencher o código deste estado conforme a 'Tabela de UF'.",
                              'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                              'fail' => true];
                }
                if (!$aluno['cod_cartorio']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que o número da certidão civil do(a) aluno(a) {$nomeAluno} foi informada, portanto é necessário informar também o código do cartório conforme a 'Tabela de Cartórios'.",
                              'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: Estado emissão / Data emissão)',
                              'linkPath' => "/intranet/atendidos_cad.php?cod_pessoa_fj={$idpesAluno}",
                              'fail' => true];
                }
            ...
            if ($aluno['cep'] && !$aluno['uf_inep']) {
                $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que no cadastro do(a) aluno(a) {$nomeAluno} o endereçamento foi informado, portanto é necessário cadastrar código da UF informada conforme a 'Tabela de UF'.",
                            'path' => '(Endereçamento > Cadastros > Estados > Editar > Campo: Código INEP)',
                            'linkPath' => "/intranet/public_uf_cad.php?sigla_uf={$siglaUF}",
                            'fail' => true];
            }
            if ($aluno['cep'] && !$aluno['municipio_inep']) {
                $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verificamos que no cadastro do(a) aluno(a) {$nomeAluno} o endereçamento foi informado, portanto é necessário cadastrar código do município informado conforme a 'Tabela de Municípios'.",
                            'path' => '(Endereçamento > Cadastros > Municípios > Editar > Campo: Código INEP)',
                            'linkPath' => "/intranet/public_municipio_cad.php?idmun={$codMunicipio}",
                            'fail' => true];
            }
            if (!$aluno['zona_localizacao']) {
                $mensagem[] = ['text' => "Dados para formular o registro 70 da escola {$nomeEscola} não encontrados. Verifique se a zona/localização do (a) aluno(a) $nomeAluno foi informada.",
    ...
    protected function analisaEducacensoRegistro80()
    {
        ...
        foreach ($alunos as $aluno) {
            ...
            if (is_null($aluno['transporte_escolar'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 80 da escola {$nomeEscola} não encontrados. Verifique se o transporte púlblico foi informado para o(a) aluno(a) {$nomeAluno}.",
            ...
            if ($aluno['transporte_escolar'] == $transporteMunicipal || $aluno['transporte_escolar'] == $transporteEstadual) {
                if (!$aluno['veiculo_transporte_escolar']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 80 da escola {$nomeEscola} não encontrados. Verificamos que o(a) aluno(a) {$nomeAluno} utiliza o transporte público, portanto é necessário informar qual o tipo de veículo utilizado.",
          ...
          $aluno['tipo_atendimento'] != $atendimentoEducEspecializado) {
                if (!$aluno['recebe_escolarizacao_em_outro_espaco']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 80 da escola {$nomeEscola} não encontrados. Verificamos que a turma vinculada a este aluno(a) {$nomeAluno} não é de Atividade complementar e nem de AEE, portanto é necessário informar se o mesmo recebe escolarização em um espaço diferente da respectiva escola.",
            ...
            if (in_array($aluno['etapa_ensino'], $etapasEnsinoCorrecao)) {
                if (!$aluno['etapa_turma']) {
                    $mensagem[] = ['text' => "Dados para formular o registro 80 do(a) aluno(a) {$nomeAluno} não encontrados. Verificamos que a etapa do aluno não foi informada.",
    ...
    protected function analisaEducacensoRegistro89()
    {
        ...
        foreach ($escolas as $escola) {
            ...
            if (is_null($escola['inep'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 89 da escola {$nomeEscola} não encontrados. Verifique se a escola possui o código INEP cadastrado.",
                            'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Dados gerais > Campo: Código INEP)',
                            'fail' => true];
            }

            if ($escola['cpf_gestor'] <= 0) {
                $mensagem[] = ['text' => "Dados para formular o registro 89 da escola {$nomeEscola} não encontrados. Verifique se o(a) gestor(a) escolar possui o CPF cadastrado.",
                            'path' => '(Pessoas > Cadastros > Pessoas físicas > Cadastrar > Editar > Campo: CPF)',
                            'fail' => true];
            }

            if (is_null($escola['nome_gestor'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 89 da escola {$nomeEscola} não encontrados. Verifique se o(a) gestor(a) escolar foi informado(a).",
                            'path' => '(Escola > Cadastros > Escolas > Cadastrar > Editar > Aba: Dados gerais > Campo: Gestor escolar)',
                            'fail' => true];
            }

            if (is_null($escola['cargo_gestor'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 89 da escola {$nomeEscola} não encontrados. Verifique se o cargo do(a) gestor(a) escolar foi informado.",
    ...
    protected function analisaEducacensoRegistro90()
    {
        ...
        foreach ($alunos as $aluno) {
            ...
            if (is_null($aluno['inep_turma']) && $ultimaTurmaVerificada != $aluno['nome_turma']) {
                $mensagem[] = ['text' => "Dados para formular o registro 90 da escola {$nomeEscola} não encontrados. Verifique se a turma {$nomeTurma} possui o código INEP cadastrado.",
            ...
            if (is_null($aluno['inep_aluno'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 90 da escola {$nomeEscola} não encontrados. Verifique se o(a) aluno(a) {$nomeAluno} possui o código INEP cadastrado.",
    ...
    protected function analisaEducacensoRegistro91()
    {
        ...
        foreach ($alunos as $aluno) {
            ...
            if (is_null($aluno['cod_inep'])) {
                $mensagem[] = ['text' => "Dados para formular o registro 91 da escola {$nomeEscola} não encontrados. Verifique se o(a) aluno(a) {$nomeAluno} possui o código INEP cadastrado.",
                            'path' => '(Escola > Cadastros > Alunos > Editar > Campo: Código INEP)',
                            'linkPath' => '#',
                            'fail' => true];
            }
