...
class EducacensoAnaliseController extends ApiCoreController
{
  ...
  protected function analisaEducacensoRegistro10() {
    ...
    $sql = "SELECT escola.local_funcionamento AS local_funcionamento,
                   ...
                   CASE WHEN e.abastecimento_agua::varchar LIKE \'%1%\' THEN 1 ELSE 0 END AS agua_rede_publica,
                   CASE WHEN e.abastecimento_agua::varchar LIKE \'%2%\' THEN 1 ELSE 0 END AS agua_poco_artesiano,
                   CASE WHEN e.abastecimento_agua::varchar LIKE \'%3%\' THEN 1 ELSE 0 END AS agua_cacimba_cisterna_poco,
                   CASE WHEN e.abastecimento_agua::varchar LIKE \'%4%\' THEN 1 ELSE 0 END AS agua_fonte_rio,
                   CASE WHEN e.abastecimento_agua::varchar LIKE \'%5%\' THEN 1 ELSE 0 END AS agua_inexistente,
                   CASE WHEN e.abastecimento_energia::varchar LIKE \'%1%\' THEN 1 ELSE 0 END AS energia_rede_publica,
                   CASE WHEN e.abastecimento_energia::varchar LIKE \'%2%\' THEN 1 ELSE 0 END AS energia_gerador,
                   CASE WHEN e.abastecimento_energia::varchar LIKE \'%3%\' THEN 1 ELSE 0 END AS energia_outros,
                   CASE WHEN e.abastecimento_energia::varchar LIKE \'%4%\' THEN 1 ELSE 0 END AS energia_inexistente,
