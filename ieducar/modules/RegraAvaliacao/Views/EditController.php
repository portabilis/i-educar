...
';
    ...
    public function Gerar()
    {
      ...
      $this->getEntity()->get('tipoNota'),
        ...
        $tabelaArredondamentoNumerico = $this->getDataMapper()->findTabelaArredondamento($this->getEntity(), ['tipo_nota' => 1]);
        ...
        $tabelaArredondamentoConceitual = $this->getDataMapper()->findTabelaArredondamento($this->getEntity(), ['tipo_nota' => 2]);
        ...
        if (empty($tabelaArredondamento)) {
            $tabelaArredondamento = [0 => 'O tipo de nota não possui tabela de arredondamento.'];
        }
