...
require_once "Reports/Reports/BibliotecaEditoraReport.php";
 ...
 */
class BibliotecaEditoraController extends Portabilis_Controller_ReportCoreController
{
  ...
  protected $_titulo = 'Relat&oacute;rio de Editoras';
	...
	function report() {
	  return new BibliotecaEditoraReport();
	}
