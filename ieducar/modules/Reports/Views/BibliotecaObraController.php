...
require_once "Reports/Reports/BibliotecaObraReport.php";

/**
 * BibliotecaObraController class.
 *
 * @author      Ricardo Bortolotto Dagostim <ricardo@portabilis.com.br>
 * @category    i-Educar
 * @license     @@license@@
 ...
 */
class BibliotecaObraController extends Portabilis_Controller_ReportCoreController
{
  ...
  protected $_titulo = 'Relat&oacute;rio de Obras';
	...
	function report() {
	  return new BibliotecaObraReport();
	}
