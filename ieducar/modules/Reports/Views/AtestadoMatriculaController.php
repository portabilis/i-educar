...
require_once "Reports/Reports/AtestadoMatriculaReport.php";

/**
 * AtestadoMatriculaController class.
 *
 * @author      Ricardo Bortolotto Dagostim <ricardo@portabilis.com.br>
 * @category    i-Educar
 * @license     @@license@@
 ...
 */
class AtestadoMatriculaController extends Portabilis_Controller_ReportCoreController
{
  ...
  protected function _preRender(){
    ...
    $localizacao->entradaCaminhos( array(
         ...
         ""                                  => "Emiss&atilde;o de atestado de matr&iacute;cula"             
    ));
