...
class PessoatransporteController extends Portabilis_Controller_Page_EditController
{
    ...
    {
        $this->_options = $this->mergeOptions(['edit_success' => '/intranet/transporte_pessoa_lst.php','delete_success' => '/intranet/transporte_pessoa_lst.php'], $this->_options);
    ...
    public function Gerar()
    {
        ...
        // Rota
        $options = ['label' =>Portabilis_String_Utils::toLatin1($this->_getLabel('rota')), 'required' => true, 'resources' => $rota_resources];
        $this->inputsHelper()->select('rota', $options);

        // Ponto de Embarque
        $options = ['label' =>Portabilis_String_Utils::toLatin1($this->_getLabel('ponto')), 'required' => false, 'resources' => ['' => 'Selecione uma rota acima']];
        ...
        $this->inputsHelper()->select('turno', ['required' => false, 'resources' => [ 0 => 'Selecione', 1 => 'Matutino', 2 => 'Vespertino', 3 => 'Noturno', 4 => 'Integral']]);
