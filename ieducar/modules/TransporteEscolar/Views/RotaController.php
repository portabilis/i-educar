...
class RotaController extends Portabilis_Controller_Page_EditController
{
    ...
    {
        $this->_options = $this->mergeOptions(['edit_success' => '/intranet/transporte_rota_lst.php','delete_success' => '/intranet/transporte_rota_lst.php'], $this->_options);
    ...
    public function Gerar()
    {
        ...
        // ano
        $options = ['label' => Portabilis_String_Utils::toLatin1($this->_getLabel('ano')), 'required' => true, 'size' => 5, 'max_length' => 4];
        ...
        // descricao
        $options = ['label' => Portabilis_String_Utils::toLatin1($this->_getLabel('desc')), 'required' => true, 'size' => 50, 'max_length' => 50];
        ...
        // Empresa rota
        $options = ['label' => $this->_getLabel('ref_cod_empresa_transporte_escolar'), 'required' => true, 'size' => 50];
        $this->inputsHelper()->simpleSearchEmpresa('ref_cod_empresa_transporte_escolar', $options);

        // Tipo
        $tipos = [null           => 'Selecione um tipo', 'U' => 'Urbana',
       'R' => 'Rural'];

        $options = ['label'     => $this->_getLabel('tipo_rota'),
                     'resources' => $tipos,
                     'required'  => true];
        ...
        // km pavimentados
        $options = ['label' => $this->_getLabel('km_pav'), 'required' => false, 'size' => 9, 'max_length' => 10, 'placeholder' => ''];
        $this->inputsHelper()->numeric('km_pav', $options);

        // km não pavimentados
        $options = ['label' => $this->_getLabel('km_npav'), 'required' => false, 'size' => 9, 'max_length' => 10, 'placeholder' => ''];
