...
class ItinerarioController extends Portabilis_Controller_Page_EditController
{
    ...
    {
        $this->_options = $this->mergeOptions(['edit_success' => '/intranet/transporte_rota_lst.php','delete_sucess' => '/intranet/transporte_rota_lst.php'], $this->_options);
    }
    ...
    public function Gerar()
    {
        ...
        // descricao
        $options = ['label' => Portabilis_String_Utils::toLatin1($this->_getLabel('descricao')), 'disabled' => true, 'size' => 50, 'max_length' => 50];
