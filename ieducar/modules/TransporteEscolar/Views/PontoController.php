...
class PontoController extends Portabilis_Controller_Page_EditController
{
    ...
    {
        $this->_options = $this->mergeOptions(['edit_success' => '/intranet/transporte_ponto_lst.php','delete_success' => '/intranet/transporte_ponto_lst.php'], $this->_options);
    ...
    public function Gerar()
    {
        ...
        // descricao
        $options = ['label' => Portabilis_String_Utils::toLatin1($this->_getLabel('desc')), 'required' => true, 'size' => 50, 'max_length' => 70];
      ...
      false
        ...
        $helperOptions = ['objectName'         => 'municipio',
        ...
        $helperOptions = ['objectName'         => 'distrito',
