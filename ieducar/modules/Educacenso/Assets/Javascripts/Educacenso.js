$j(document).ready(function(){
  ...
  var modalExport = '<div id="modal_export" class="modal" style="display:none; text-align:center">' +
            ...
            '</div>'+
             ...
             ' <p style="margin-left: 20px; margin-top: 30px;font-family: verdana, arial; font-size: 18px;">Parabéns! Até o momento todos os dados da sua escola, foram validados com sucesso!</p>' +
             ...
             ' <p style="margin-left: 20px; margin-top: 30px;font-family: verdana, arial; font-size: 18px;">Próximos passos</p>' +
             ' <ul>' +
