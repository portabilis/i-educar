...
class EditController extends Core_Controller_Page_EditController
{
    ...
    private function carregaCamposNotasConceituais()
    {
        ...
        // Inicio da tabela
        $this->campoTabelaInicio('tabela_arredondamento', 'Notas para arredondamento', ['ID','Rótulo da nota', 'Descrição', 'Valor mínimo', 'Valor máximo'], $this->tabela_arredondamento_valor);
    ...
    private function carregaCamposNotasNumericas()
    {
        ...
        // Inicio da tabela
        $this->campoTabelaInicio('tabela_arredondamento_numerica', 'Notas para arredondamento', ['ID','Nome', 'Casa decimal', 'Ação', 'Casa decimal exata'], $this->tabela_arredondamento_valor);
