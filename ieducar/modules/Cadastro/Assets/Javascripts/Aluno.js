    ...
    ************************/
    ...
    $j("#editar-pessoa-link").click(function() {
        ...
        if ($j('#cep_').val()){
          ...
          $j('#telefone_1').val(person_details.idmun);
          $j('#telefone_mov').val(person_details.idmun);
