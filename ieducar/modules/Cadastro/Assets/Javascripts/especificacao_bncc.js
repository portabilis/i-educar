...
<div id="tabControl">
  <ul>
    <li>
      <div id="tab1" class="bnccTab">
        <span class="tabText">Dados gerais</span>
      </div>
    </li>
    <li>
      <div id="tab2" class="bnccTab">
        <span class="tabText">Currículo do Estado</span>
      </div>
    </li>
  </ul>
</div>`);
...
$j('#tab1').click(
function(){
  $j('.bnccTab-active').toggleClass('bnccTab-active bnccTab');
  $j('#tab1').toggleClass('bnccTab bnccTab-active')
  $j('.tablecadastro >tbody  > tr').each(function(index, row) {
    if (index>=linha_inicial_tipo){
      if (row.id!='stop')
        row.hide();
...
function(){
  $j('.bnccTab-active').toggleClass('bnccTab-active bnccTab');
  $j('#tab2').toggleClass('bnccTab bnccTab-active')
  $j('.tablecadastro >tbody  > tr').each(function(index, row) {
    if (row.id!='stop'){
      if (index>=linha_inicial_tipo){
