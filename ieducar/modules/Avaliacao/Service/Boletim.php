   ...
   */
    ...
    public function getSituacaoNotaFalta($flagSituacaoNota, $flagSituacaoFalta)
    {
      ...
      case App_Model_MatriculaSituacao::REPROVADO:
        ...
        $situacoesFinais = [App_Model_MatriculaSituacao::REPROVADO, App_Model_MatriculaSituacao::APROVADO, App_Model_MatriculaSituacao::APROVADO_APOS_EXAME];
    ...
    public function getSituacaoFaltas()
    {
        ...
        if ($tipoFaltaGeral) {
          ...
          $this->_calculatePorcentagem(
              $this->_componentes[$id]->cargaHoraria,
            $faltasComponentes[$id]->horasFaltas,
              false
          );
    ...
    public function updateMediaComponente($media, $componente, $etapa)
    {
      ...
      'etapa' => $etapa,
        ...
        try {
            ...
            $this->getNotaComponenteMediaDataMapper()->find([
