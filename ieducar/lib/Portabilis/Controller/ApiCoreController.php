...
class ApiCoreController extends Core_Controller_Page_EditController
{
  ...
  // variaveis usadas apenas em formulários, desnecesário subescrever nos filhos.
    ...
    */
    ...
    /**
     * Return an user array info from current session
     *
     * @return array user
     */
    ...
    /**
     * Validate access key from request
     *
     * @return boolean
     */
    ...
    /**
     * Vaidate if user are loggeIn or has valid accessKey and signature
     *
     * @return boolean
     */
    ...
    /**
     * Validates if curren user is admin
     *
     * @return boolean
     */
    ...
    */
    ...
    protected function validatesExistenceOf($resourceName, $value, $options = [])
    {
        ...
        if (is_array($value)) {
            $valid = true;
            foreach ($value as $v) {
                $valid = $valid && $this->validator->validatesValueIsInBd(
            $options['field_name'],
                                                    $v,
                                                    $options['schema_name'],
                                                    $resourceName,
