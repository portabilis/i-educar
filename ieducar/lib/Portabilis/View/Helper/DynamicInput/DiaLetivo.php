...
class Portabilis_View_Helper_DynamicInput_DiaLetivo extends Portabilis_View_Helper_DynamicInput_CoreSelect
{
    protected function inputName()
    {
        return 'ref_cod_dia_letivo';
    }
    ...
    public function diaLetivo($options = [])
    {
