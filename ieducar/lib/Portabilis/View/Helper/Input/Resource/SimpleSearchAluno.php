...
/**
 * Portabilis_View_Helper_Input_SimpleSearchAluno class.
 *
 * @author    Lucas D'Avila <lucasdavila@portabilis.com.br>
 * @category  i-Educar
 * @license   @@license@@
...
class Portabilis_View_Helper_Input_Resource_SimpleSearchAluno extends Portabilis_View_Helper_Input_SimpleSearch {
  ...
  public function simpleSearchAluno($attrName = '', $options = array()) {
    $defaultOptions = array('objectName'    => 'aluno',
                            'apiController' => 'Aluno',
  ...
  protected function placeholderJs($options) {
    ...
    $js             = "if (typeof $optionsVarName == 'undefined') { $optionsVarName = {} };
                       $optionsVarName.placeholder = stringUtils.toUtf8('Informe o nome do aluno ou código');";
