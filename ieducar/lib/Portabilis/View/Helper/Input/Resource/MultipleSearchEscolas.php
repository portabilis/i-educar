 ...
 */
class Portabilis_View_Helper_Input_Resource_MultipleSearchEscolas extends Portabilis_View_Helper_Input_MultipleSearch {

  protected function getOptions($resources) {
    if (empty($resources)) {
      $resources = new clsPmieducarEscola();
      $resources = $resources->lista_escolas_usuarios();
  ...
  public function multipleSearchEscolas($attrName, $options = array()) {
    $defaultOptions = array('objectName'    => 'escolas',
                            'apiController' => 'EscolaUsuario',
