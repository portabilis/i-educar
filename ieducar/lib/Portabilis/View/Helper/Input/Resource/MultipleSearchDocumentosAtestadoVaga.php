    ...
    protected function getOptions($resources)
    {
        if (empty($resources)) {
            $resources = [
                ...
                'decla_vacina' => 'Declara&ccedil;ão de vacina da unidade de sa&uacute;de original',
                ...
                'tit_eleitor' => 'T&iacute;tulo de eleitor do responsável',
                'doc_nis' => 'N&uacute;mero de Identifica&ccedil;ão Social - NIS',
