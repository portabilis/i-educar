...
class AjusteView9AnosMatriculaDependencia extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        SELECT historico.cod_aluno,
           ...
           FROM ( SELECT historico_disciplinas.ref_ref_cod_aluno AS cod_aluno,
                    relatorio.get_texto_sem_caracter_especial(upper(btrim(historico_disciplinas.nm_disciplina))::character varying) AS disciplina,
                    ( SELECT
                                CASE
                 ...
                 FROM ( SELECT historico_disciplinas_1.sequencial,
                          ...
                          btrim(relatorio.get_texto_sem_caracter_especial(historico_disciplinas_1.nm_disciplina::character varying)::text) AS nm_disciplina,
