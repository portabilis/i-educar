...
class AjustaFunctionCountWeekdays extends AbstractMigration
{
    public function up()
    {
        $this->execute("CREATE OR REPLACE FUNCTION relatorio.count_weekdays(start_date date, end_date date) RETURNS INTEGER AS $$
                        DECLARE
                          tmp_date date;
                          tmp_dow integer;
