...
class CriaFuncaoCopiaAnosLetivos extends AbstractMigration
{
    public function up()
    {

        $sql = <<<SQL
            CREATE OR REPLACE FUNCTION pmieducar.copiaAnosLetivos(iAnoNovo smallint, iCodEscola integer)
...
SQL;
    ...
    // select pmieducar.copiaAnosLetivos(2018, 16)

    public function down()
    {
        $this->execute('DROP FUNCTION pmieducar.copiaAnosLetivos(smallint, integer);');
    }
}
