...
class CorrigeFuncaoFrequenciaGeralMatricula extends AbstractMigration
{
    public function up()
    {
        $this->query("CREATE OR REPLACE FUNCTION modules.frequencia_da_matricula(p_matricula_id integer)
