...
class NaoApresentaRemanejadosQuandoNaoTemDataBaseViewSituacao extends AbstractMigration
{
    public function change()
    {
        $this->execute("
            ...
            WHERE matricula.ativo = 1 AND
                    CASE WHEN instituicao.data_base_remanejamento IS NULL THEN COALESCE(matricula_turma.remanejado, false) = false ELSE TRUE END AND
                    CASE
