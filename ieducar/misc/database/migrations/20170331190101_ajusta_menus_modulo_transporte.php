...
class AjustaMenusModuloTransporte extends AbstractMigration
{
    public function change()
    {
      $this->execute("UPDATE pmicontrolesis.menu SET tt_menu = 'Movimentações' WHERE cod_menu = 20711;
                      ...
                      UPDATE portal.menu_submenu SET nm_submenu = 'Relatório de motoristas do transporte' WHERE cod_menu_submenu = 21252;
                      UPDATE pmicontrolesis.menu SET tt_menu = 'Relatório de motoristas do transporte' WHERE cod_menu = 21252;
                      UPDATE portal.menu_submenu SET nm_submenu = 'Relatório de usuários do transporte' WHERE cod_menu_submenu = 999825;
                      UPDATE pmicontrolesis.menu SET tt_menu = 'Relatório de usuários do transporte' WHERE cod_menu = 999825;
                      UPDATE portal.menu_submenu SET nm_submenu = 'Relatório de rotas do transporte' WHERE cod_menu_submenu = 21242;
                      UPDATE pmicontrolesis.menu SET tt_menu = 'Relatório de rotas do transporte' WHERE cod_menu = 21242;
                      UPDATE portal.menu_submenu SET nm_submenu = 'Relatório de alunos do transporte' WHERE cod_menu_submenu = 21249;
                      UPDATE pmicontrolesis.menu SET tt_menu = 'Relatório de alunos do transporte' WHERE cod_menu = 21249;
                      UPDATE portal.menu_submenu SET nm_submenu = 'Relatório de usuários do transporte por empresa' WHERE cod_menu_submenu = 21243;
