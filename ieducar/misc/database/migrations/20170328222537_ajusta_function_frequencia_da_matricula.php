...
class AjustaFunctionFrequenciaDaMatricula extends AbstractMigration
{
    public function change()
    {
      $this->execute("CREATE OR REPLACE FUNCTION modules.frequencia_da_matricula(p_matricula_id integer) RETURNS double precision AS $$
                      DECLARE
