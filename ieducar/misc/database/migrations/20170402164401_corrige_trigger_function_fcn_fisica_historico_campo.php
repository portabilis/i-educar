...
class CorrigeTriggerFunctionFcnFisicaHistoricoCampo extends AbstractMigration
{
    public function change()
    {
      $this->execute("CREATE OR REPLACE FUNCTION consistenciacao.fcn_fisica_historico_campo()
                        RETURNS trigger AS
                      $$
                      DECLARE
                        v_idpes       numeric;
