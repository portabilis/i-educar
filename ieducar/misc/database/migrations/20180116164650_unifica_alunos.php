...
class UnificaAlunos extends AbstractMigration
{
    public function up()
    {
        $sql = "
        CREATE OR REPLACE FUNCTION pmieducar.unifica_alunos(alunoPrincipal NUMERIC, alunos NUMERIC[], usuario INTEGER) RETURNS void AS $$
        DECLARE
