...
class CriaFunctionGetSituacaoComponenteCurricular extends AbstractMigration
{
    public function up()
    {
        $this->execute("CREATE OR REPLACE FUNCTION relatorio.get_situacao_componente(cod_situacao numeric) 
                        RETURNS VARCHAR AS $$
                        DECLARE
