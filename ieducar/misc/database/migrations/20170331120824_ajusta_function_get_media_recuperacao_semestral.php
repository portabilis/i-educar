...
class AjustaFunctionGetMediaRecuperacaoSemestral extends AbstractMigration
{
    public function change()
    {
      $this->execute("CREATE OR REPLACE FUNCTION relatorio.get_media_recuperacao_semestral(
                          matricula integer,
                          componente integer)
                        RETURNS numeric AS
                      $$
                        ...
                        COST 100;
                      ALTER FUNCTION relatorio.get_media_recuperacao_semestral(integer, integer)
                        OWNER TO postgres;");
    }
}
