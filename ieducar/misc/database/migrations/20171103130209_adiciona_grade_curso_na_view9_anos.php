...
class AdicionaGradeCursoNaView9Anos extends AbstractMigration
{
...
CREATE OR REPLACE VIEW relatorio.view_historico_9anos AS 
    SELECT historico.grade_curso_1,
    historico.grade_curso_2,
    historico.grade_curso_3,
    historico.grade_curso_4,
    historico.grade_curso_5,
    historico.grade_curso_6,
    historico.grade_curso_7,
    historico.grade_curso_8,
    historico.grade_curso_9,
    historico.cod_aluno,
   ...
   FROM ( SELECT historico_disciplinas.ref_ref_cod_aluno AS cod_aluno,
        ...
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'1\') AS grade_curso_1,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'2\') AS grade_curso_2,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'3\') AS grade_curso_3,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'4\') AS grade_curso_4,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'5\') AS grade_curso_5,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'6\') AS grade_curso_6,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'7\') AS grade_curso_7,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'8\') AS grade_curso_8,
        (SELECT historico_grade_curso_id FROM pmieducar.historico_escolar he WHERE he.ref_cod_aluno = historico_escolar.ref_cod_aluno AND "substring"(btrim(he.nm_serie::text), 1, 1) = \'9\') AS grade_curso_9,
