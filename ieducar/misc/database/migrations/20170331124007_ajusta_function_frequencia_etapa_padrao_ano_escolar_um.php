...
class AjustaFunctionFrequenciaEtapaPadraoAnoEscolarUm extends AbstractMigration
{
    public function change()
    {
      $this->execute("DROP FUNCTION modules.frequencia_etapa_padrao_ano_escolar_um(integer, integer, integer);
                      CREATE OR REPLACE FUNCTION modules.frequencia_etapa_padrao_ano_escolar_um(
                          cod_matricula_aluno integer,
                          cod_etapa integer,
