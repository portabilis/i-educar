...
class CriaFunctionGetTotalGeralFaltaComponente extends AbstractMigration
{
    public function up()
    {
        $this->execute("CREATE OR REPLACE FUNCTION relatorio.get_total_geral_falta_componente(matricula_i integer) RETURNS NUMERIC AS $$
                        BEGIN
