...
class AlteraViewHistoricoEscolar9anosLimparEspacoDosNomesdasDisciplinas extends AbstractMigration
{
 ...
 SELECT historico.cod_aluno,
   ...
   FROM ( SELECT historico_disciplinas.ref_ref_cod_aluno AS cod_aluno,
            relatorio.get_texto_sem_caracter_especial(historico_disciplinas.nm_disciplina::character varying) AS disciplina,
            ( SELECT
                        CASE
                  ...
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND relatorio.get_texto_sem_caracter_especial(upper(btrim(hd.nm_disciplina))::text::character varying)::text = relatorio.get_texto_sem_caracter_especial(upper(btrim(historico_disciplinas.nm_disciplina))::character varying)::text AND historico_escolar_1.ativo = 1 AND historico_escolar_1.extra_curricular = 0 AND \"substring\"(historico_escolar_1.nm_serie::text, 1, 1) = 1::text AND historico_escolar_1.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = historico_escolar_1.ref_cod_aluno AND \"substring\"(historico_escolar_1.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0  AND hee.dependencia = FALSE))
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 1::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 2::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 3::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 4::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 5::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 6::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 7::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 8::text AND he.dependencia = FALSE
            ...
            ( SELECT he.ano
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1 AND hee.extra_curricular = 0)) AND \"substring\"(he.nm_serie::text, 1, 1) = 9::text AND he.dependencia = FALSE
            ...
            ( SELECT hd.dependencia
               ...
               WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno
                 AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                                              FROM historico_escolar hee
                                             WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno
                                               AND relatorio.get_texto_sem_caracter_especial(upper(btrim(hd.nm_disciplina))::text::character varying)::text = relatorio.get_texto_sem_caracter_especial(upper(btrim(historico_disciplinas.nm_disciplina))::character varying)::text
                                               AND \"substring\"(hee.nm_serie::text, 1, 1) = 1::text
                                               AND hee.ativo = 1
            ...
            ( SELECT hd.carga_horaria_disciplina
                  ...
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 1::text))
                 LIMIT 1) AS carga_horaria_disciplina1,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 2::text))
                 LIMIT 1) AS carga_horaria_disciplina2,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 3::text))
                 LIMIT 1) AS carga_horaria_disciplina3,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 4::text))
                 LIMIT 1) AS carga_horaria_disciplina4,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 5::text))
                 LIMIT 1) AS carga_horaria_disciplina5,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 6::text))
                 LIMIT 1) AS carga_horaria_disciplina6,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 7::text))
                 LIMIT 1) AS carga_horaria_disciplina7,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 8::text))
                 LIMIT 1) AS carga_horaria_disciplina8,
            ( SELECT hd.carga_horaria_disciplina
                   FROM historico_disciplinas hd
                  WHERE hd.ref_ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND hd.ref_sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd.nm_disciplina::text) = fcn_upper(historico_disciplinas.nm_disciplina) AND \"substring\"(hee.nm_serie::text, 1, 1) = 9::text))
            ...
            ( SELECT DISTINCT
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '1'::text AND he.dependencia = FALSE) AS status_serie1,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '2'::text AND he.dependencia = FALSE) AS status_serie2,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '3'::text AND he.dependencia = FALSE) AS status_serie3,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '4'::text AND he.dependencia = FALSE) AS status_serie4,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '5'::text AND he.dependencia = FALSE) AS status_serie5,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '6'::text AND he.dependencia = FALSE) AS status_serie6,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '7'::text AND he.dependencia = FALSE) AS status_serie7,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '8'::text AND he.dependencia = FALSE) AS status_serie8,
            ( SELECT DISTINCT
                        CASE
                            WHEN he.aceleracao = 1 THEN
                            CASE
                  ...
                  WHERE he.ref_cod_aluno = historico_disciplinas.ref_ref_cod_aluno AND he.ativo = 1 AND he.sequencial = (( SELECT max(hee.sequencial) AS max
                           FROM historico_escolar hee
                          WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND \"substring\"(he.nm_serie::text, 1, 1) = \"substring\"(hee.nm_serie::text, 1, 1) AND hee.ativo = 1)) AND \"substring\"(he.nm_serie::text, 1, 1) = '9'::text AND he.dependencia = FALSE) AS status_serie9
           FROM ( SELECT historico_disciplinas_1.sequencial,
                    ...
                    btrim(relatorio.get_texto_sem_caracter_especial(historico_disciplinas_1.nm_disciplina::text::character varying)::text) AS nm_disciplina,
