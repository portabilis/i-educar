...
class CorrigeFunctionCriacaoDeDocumentoPessoaFisica extends AbstractMigration
{
    public function change()
    {
      ...
      $this->execute("CREATE OR REPLACE FUNCTION consistenciacao.fcn_documento_historico_campo()
                        RETURNS trigger AS
                      $$
                        DECLARE
                          v_idpes         numeric;
                          ...
                          */
                          BEGIN
                            ...
                            END IF;
                            -- RG
                            IF v_numero_rg_novo::integer <= 0 OR v_numero_rg_novo IS NULL THEN
