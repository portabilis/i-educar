...
class CriaFunctionGetTotalFaltas extends AbstractMigration
{
    public function up()
    {
        $this->execute("CREATE OR REPLACE FUNCTION relatorio.get_total_faltas(matricula_i integer) RETURNS NUMERIC AS $$
                        BEGIN
