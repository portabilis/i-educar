...
class AdicionaSituacaoFalecidoViewSituacaoParauapebas extends AbstractMigration
{
    public function up()
    {
        $this->execute("DROP VIEW relatorio.view_situacao_parauapebas;
                        ...
                        SELECT matricula.cod_matricula,
                          ...
                          (SELECT CASE
                                      ...
                                      WHEN matricula_turma.abandono
                                           OR matricula.aprovado = 6 THEN CASE
                                                                              WHEN matricula.ref_cod_abandono_tipo IS NOT NULL THEN
                                                                                     (SELECT abandono_tipo.nome
                                                                                      FROM abandono_tipo
                        ...
                        WHERE CASE
                                  ...
                                  WHEN matricula.aprovado = 15 THEN matricula_turma.ativo = 1
                          ...
                          AND CASE
                                  ...
                                  WHEN situacao_matricula.cod_situacao = 9 THEN (matricula.aprovado = ANY (ARRAY[1, 2, 3, 5, 12, 13, 14]))
                                       ...
                                       AND (NOT matricula_turma.falecido
                                            OR matricula_turma.falecido IS NULL)
                                  WHEN situacao_matricula.cod_situacao = ANY (ARRAY[1, 2, 3, 12, 13]) THEN matricula.aprovado = situacao_matricula.cod_situacao
                                       AND (NOT matricula_turma.reclassificado
                                            OR matricula_turma.reclassificado IS NULL)
                                       AND (NOT matricula_turma.abandono
                                            OR matricula_turma.abandono IS NULL)
                        ...
                        ALTER TABLE relatorio.view_situacao_parauapebas OWNER TO postgres;");
    }
}
