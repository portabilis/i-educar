...
class CriaFunctionGetMediaGeralTurma extends AbstractMigration
{
    public function up()
    {
        $this->execute("CREATE OR REPLACE FUNCTION relatorio.get_media_geral_turma(turma_i integer, componente_i integer) RETURNS NUMERIC AS $$
                        BEGIN
