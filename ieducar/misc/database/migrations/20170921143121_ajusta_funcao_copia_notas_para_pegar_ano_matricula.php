...
class AjustaFuncaoCopiaNotasParaPegarAnoMatricula extends AbstractMigration
{
    public function change()
    {
        $this->execute(
            "CREATE OR REPLACE FUNCTION modules.copia_notas_transf(
                old_matricula_id integer,
                new_matricula_id integer)
