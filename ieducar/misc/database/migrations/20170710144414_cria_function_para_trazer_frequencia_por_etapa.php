...
class CriaFunctionParaTrazerFrequenciaPorEtapa extends AbstractMigration
{
    public function up()
    {
        $this->execute('CREATE OR REPLACE FUNCTION modules.frequencia_matricula_por_etapa(matricula integer,etapa varchar)
                        RETURNS numeric AS
                        $BODY$
                          DECLARE
                            matricula integer;
                        ...
                        ALTER FUNCTION frequencia_matricula_por_etapa(integer,varchar) OWNER TO ieducar;');
    }
}
