...
class AjustaViewPosicionamentoAdicionaCampoCargaHorariaDisciplina extends AbstractMigration {
  ...
  FROM historico_escolar hee2
   JOIN pmieducar.historico_disciplinas hdd2 ON hdd2.ref_ref_cod_aluno = hee2.ref_cod_aluno
   AND hdd2.ref_sequencial = hee2.sequencial
   WHERE hee2.ref_cod_aluno = he.ref_cod_aluno
     AND fcn_upper(hdd2.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)) AS order_componente,
...
JOIN pmieducar.historico_escolar he ON hd.ref_ref_cod_aluno = he.ref_cod_aluno
...
AND he1.sequencial = (
                        (SELECT hee.sequencial
                         ...
                         WHERE hee.ref_cod_aluno = he.ref_cod_aluno
                           AND hee.posicao = 1
                           AND hee.ativo = 1
                         ORDER BY hee.ano DESC, hee.aprovado LIMIT 1))
...
AND fcn_upper(hd1.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd2.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd3.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd4.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd5.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd6.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd7.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd8.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
...
AND fcn_upper(hd9.nm_disciplina::text) = fcn_upper(hd.nm_disciplina)
AND hd9.ref_sequencial = he9.sequencial
WHERE he.ativo = 1
  AND he.posicao IS NOT NULL
GROUP BY he.ref_cod_aluno,
         ...
         hd8.nota,
         hd9.nota,
         hd1.carga_horaria_disciplina,
         hd2.carga_horaria_disciplina,
         hd3.carga_horaria_disciplina,
         hd4.carga_horaria_disciplina,
         hd5.carga_horaria_disciplina,
         hd6.carga_horaria_disciplina,
         hd7.carga_horaria_disciplina,
         hd8.carga_horaria_disciplina,
         hd9.carga_horaria_disciplina,
         hd1.faltas,
         hd2.faltas,
         hd3.faltas,
         hd4.faltas,
