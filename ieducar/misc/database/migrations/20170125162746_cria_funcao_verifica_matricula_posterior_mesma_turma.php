...
class CriaFuncaoVerificaMatriculaPosteriorMesmaTurma extends AbstractMigration
{
  public function up()
  {
    $this->execute("
      CREATE OR REPLACE FUNCTION verifica_existe_matricula_posterior_mesma_turma(cod_matricula integer, cod_turma integer, sequencial integer) RETURNS BOOLEAN AS $$
