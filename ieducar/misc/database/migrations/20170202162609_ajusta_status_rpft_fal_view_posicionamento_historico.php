...
class AjustaStatusRpftFalViewPosicionamentoHistorico extends AbstractMigration
{
    public function up()
    {
     ...
     AND fcn_upper(hdd2.nm_disciplina) = fcn_upper(hd.nm_disciplina)) AS order_componente,
       ...
       CASE
           WHEN he1.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he1.aprovado = 14 THEN 'RpFt'
                                             WHEN he1.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he1.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he2.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he2.aprovado = 14 THEN 'RpFt'
                                             WHEN he2.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he2.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he3.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he3.aprovado = 14 THEN 'RpFt'
                                             WHEN he3.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he3.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he4.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he4.aprovado = 14 THEN 'RpFt'
                                             WHEN he4.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he4.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he5.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he5.aprovado = 14 THEN 'RpFt'
                                             WHEN he5.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he5.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he6.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he6.aprovado = 14 THEN 'RpFt'
                                             WHEN he6.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he6.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he7.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he7.aprovado = 14 THEN 'RpFt'
                                             WHEN he7.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he7.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he8.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he8.aprovado = 14 THEN 'RpFt'
                                             WHEN he8.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he8.aprovado = 1 THEN 'Apro'
       ...
       CASE
           WHEN he9.aceleracao = 1 THEN (CASE
                                             ...
                                             WHEN he9.aprovado = 14 THEN 'RpFt'
                                             WHEN he9.aprovado = 15 THEN 'Fal'
                                             ELSE ''
                                         END) || ' AC'
           ELSE (CASE
                     WHEN he9.aprovado = 1 THEN 'Apro'
                                              ...
                                              AND he1.sequencial =
                                                (SELECT hee.sequencial
                                                  ...
                                                  WHERE hee.ref_cod_aluno = he.ref_cod_aluno
                                                    AND hee.posicao = 1
                                                    AND hee.ativo = 1
                                                  ORDER BY ano DESC, aprovado ASC
                                                  LIMIT 1))
