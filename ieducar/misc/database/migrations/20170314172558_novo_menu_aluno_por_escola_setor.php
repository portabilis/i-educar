...
class NovoMenuAlunoPorEscolaSetor extends AbstractMigration
{
   public function up()
    {
        $this->execute("INSERT INTO portal.menu_submenu VALUES (999890, 55, 2,'Relatório de alunos por escola e setor', 'module/Reports/AlunoSetor', null, 3);");
        $this->execute("INSERT INTO pmicontrolesis.menu VALUES (999890, 999890, 999300, 'Relatório de alunos por escola e setor', 0, 'module/Reports/AlunoSetor', '_self', 1, 15, 192, 1);");
