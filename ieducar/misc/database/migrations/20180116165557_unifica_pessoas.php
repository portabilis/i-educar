...
class UnificaPessoas extends AbstractMigration
{
    public function up()
    {
        $sql = "
        CREATE OR REPLACE FUNCTION pmieducar.unifica_pessoas(pessoaPrincipal NUMERIC, pessoas NUMERIC[], usuario INTEGER) RETURNS void AS $$
        DECLARE
