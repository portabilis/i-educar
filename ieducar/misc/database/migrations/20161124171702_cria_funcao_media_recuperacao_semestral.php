...
class CriaFuncaoMediaRecuperacaoSemestral extends AbstractMigration
{

    public function up()
    {
        $this->query("CREATE OR REPLACE FUNCTION relatorio.get_media_recuperacao_semestral(matricula integer, componente integer)
                        RETURNS NUMERIC AS $$
                        DECLARE
                           nota_etapa1 numeric;
                           nota_etapa2 numeric;
