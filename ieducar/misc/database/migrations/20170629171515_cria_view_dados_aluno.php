...
class CriaViewDadosAluno extends AbstractMigration
{
    public function change()
    {
        $this->execute("
                            ...
                            SELECT pessoa.idpes AS idpes,
                             ...
                             INNER JOIN public.bairro ON (bairro.idbai = endereco_pessoa.idbai)
                             INNER JOIN public.logradouro ON (logradouro.idlog = endereco_pessoa.idlog)
                             INNER JOIN public.municipio ON (municipio.idmun = bairro.idmun)
                             INNER JOIN public.uf ON (uf.sigla_uf = municipio.sigla_uf)
