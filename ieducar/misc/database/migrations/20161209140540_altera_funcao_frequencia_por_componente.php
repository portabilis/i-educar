...
{
    /**
     * Alterado para receber código da turma como parâmetro
     * Alterado para verificar a carga horária do componente na turma e da série
     */
    public function up()
    {
        $this->execute("DROP FUNCTION modules.frequencia_por_componente(integer, integer, integer);
