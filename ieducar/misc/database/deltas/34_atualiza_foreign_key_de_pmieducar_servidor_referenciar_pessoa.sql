...
ALTER TABLE pmieducar.servidor ADD CONSTRAINT fk_servidor_pessoa FOREIGN KEY (cod_servidor) REFERENCES pessoa (idpes);

-- //@UNDO
ALTER TABLE pmieducar.servidor DROP CONSTRAINT fk_servidor_pessoa;
ALTER TABLE pmieducar.servidor ADD CONSTRAINT servidor_cod_servidor_fkey FOREIGN KEY (cod_servidor) REFERENCES funcionario (ref_cod_pessoa_fj) ON UPDATE RESTRICT ON DELETE RESTRICT;
