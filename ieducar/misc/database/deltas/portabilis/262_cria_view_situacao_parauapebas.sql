 ...
 SELECT matricula.cod_matricula, situacao_matricula.cod_situacao, matricula_turma.ref_cod_turma AS cod_turma, matricula_turma.sequencial, ( SELECT
                CASE
                    ...
                    WHEN matricula_turma.abandono  OR matricula.aprovado = 6 THEN
                      CASE WHEN matricula.ref_cod_abandono_tipo IS NOT NULL THEN
                        (SELECT nome FROM pmieducar.abandono_tipo WHERE cod_abandono_tipo = matricula.ref_cod_abandono_tipo)::character varying
                      ELSE
