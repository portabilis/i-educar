...
insert into portal.menu_submenu values (999823, 55, 2,'Relação de reserva de vagas por escola', 'module/Reports/RelacaoReservaVaga', null, 3);
insert into portal.menu_funcionario values(1,0,0,999823);
insert into pmicontrolesis.menu values (999823, 999823, 999300, 'Relação de reserva de vagas por escola', 0, 'module/Reports/RelacaoReservaVaga', '_self', 1, 15, 192);
