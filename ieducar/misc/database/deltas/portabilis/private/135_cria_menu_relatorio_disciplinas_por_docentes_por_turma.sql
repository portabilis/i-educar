...
insert into pmicontrolesis.menu values (999860, 999860, 999302, 'Relação de docentes e disciplinas lecionadas por turma', 0, 'module/Reports/DocentesDisciplinasPorTurma', '_self', 1, 15, 192, 1);
