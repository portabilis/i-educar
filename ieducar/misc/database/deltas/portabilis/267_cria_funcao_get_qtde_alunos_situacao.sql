...
-- Function: relatorio.get_qtde_alunos_situacao(integer, integer, integer, integer, integer, integer, integer, integer, character, integer, integer)

-- DROP FUNCTION relatorio.get_qtde_alunos_situacao(integer, integer, integer, integer, integer, integer, integer, integer, character, integer, integer);

CREATE OR REPLACE FUNCTION relatorio.get_qtde_alunos_situacao(ano integer, instituicao integer, escola integer, curso integer, serie integer, turma integer, situacao integer, bairro integer, sexo character, idadeini integer, idadefim integer)
  RETURNS integer AS
$BODY$
...
ALTER FUNCTION relatorio.get_qtde_alunos_situacao(integer, integer, integer, integer, integer, integer, integer, integer, character, integer, integer)
  OWNER TO ieducar;