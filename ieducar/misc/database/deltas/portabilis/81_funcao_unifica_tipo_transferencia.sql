  ...
  --
  -- Cria função que unifica tipos de transferência semelhantes de escolas distintas
  ...
  CREATE OR REPLACE FUNCTION pmieducar.unifica_tipos_transferencia()
  RETURNS void AS
  $BODY$
  DECLARE 
  cur_tipo RECORD;  
  ...
  SELECT pmieducar.unifica_tipos_transferencia();
