...
ALTER TABLE modules.nota_componente_curricular ALTER COLUMN nota_arredondada TYPE numeric(10);
ALTER TABLE modules.nota_componente_curricular ALTER COLUMN nota_recuperacao TYPE numeric(10);
ALTER TABLE modules.nota_componente_curricular ALTER COLUMN nota_original TYPE numeric(10);
