  ...
  INSERT INTO relatorio.situacao_matricula (cod_situacao, descricao) values (12, 'Aprovado com dependência');
...
WHERE CASE
  ...
  DELETE FROM relatorio.situacao_matricula WHERE cod_situacao = 12;
  ...
  WHERE CASE
    ...
    AND CASE
            ...
            WHEN situacao_matricula.cod_situacao = 7 THEN matricula.aprovado = 5::smallint
            WHEN situacao_matricula.cod_situacao = 9 THEN (matricula.aprovado = ANY (ARRAY[1::smallint, 2::smallint, 3::smallint, 5::smallint]))
                 AND (NOT matricula_turma.reclassificado
                      OR matricula_turma.reclassificado IS NULL)
                 AND (NOT matricula_turma.abandono
                      OR matricula_turma.abandono IS NULL)
                 ...
                 AND (NOT matricula_turma.transferido
                      OR matricula_turma.transferido IS NULL)
            WHEN situacao_matricula.cod_situacao = ANY (ARRAY[1, 2, 3]) THEN matricula.aprovado = situacao_matricula.cod_situacao
                 AND (NOT matricula_turma.reclassificado
                      OR matricula_turma.reclassificado IS NULL)
                 AND (NOT matricula_turma.abandono
                      OR matricula_turma.abandono IS NULL)
