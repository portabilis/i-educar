  ...
  --
  -- Altera tipo de dado das colunas num_termo e num_folha para facilitar migrações
  --
  -- @author   Lucas Schmoeller da Silva <lucas@portabilis.com.br>
  -- @license  @@license@@
  -- @version  $Id$

	ALTER TABLE cadastro.documento ALTER COLUMN num_termo type character varying(10);
  ALTER TABLE cadastro.documento ALTER COLUMN num_folha type character varying(10);
...
DECLARE
  ...
  v_numero_termo_certidao_civil_novo  varchar;
  v_numero_termo_certidao_civil_antigo  varchar;
  v_numero_livro_certidao_civil_novo  varchar;
  v_numero_livro_certidao_civil_antigo  varchar;
  v_numero_folha_certidao_civil_novo  varchar;
  v_numero_folha_certidao_civil_antigo  varchar;
...
ALTER FUNCTION consistenciacao.fcn_documento_historico_campo()
  ...
  -- //@UNDO
	...
	ALTER TABLE cadastro.documento ALTER COLUMN num_termo type integer;
  ALTER TABLE cadastro.documento ALTER COLUMN num_folha type integer;
...
DECLARE
  ...
  v_tipo_certidao_civil_novo    numeric;
  v_tipo_certidao_civil_antigo    numeric;
  v_numero_termo_certidao_civil_novo  integer;
  v_numero_termo_certidao_civil_antigo  integer;
  v_numero_livro_certidao_civil_novo  varchar;
  v_numero_livro_certidao_civil_antigo  varchar;
  v_numero_folha_certidao_civil_novo  integer;
  v_numero_folha_certidao_civil_antigo  integer;
  v_cartorio_certidao_civil_novo    text;
  v_cartorio_certidao_civil_antigo  text;
  v_uf_expedicao_rg_novo      text;
  v_uf_expedicao_rg_antigo    text;
