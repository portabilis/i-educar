...
SELECT ref_ref_cod_aluno AS cod_aluno,
 ...
 FROM (SELECT sequencial,
            ...
            nota,
            faltas,
            import FROM pmieducar.historico_disciplinas) historico_disciplinas
