...
ALTER TABLE modules.nota_componente_curricular ADD COLUMN nota_recuperacao varchar(5);
ALTER TABLE modules.nota_componente_curricular ADD COLUMN nota_original varchar(5);
