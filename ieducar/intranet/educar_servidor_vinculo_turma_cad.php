...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $options = ['label' => Portabilis_String_Utils::toLatin1('Função exercida'), 'resources' => $resources, 'value' => $this->funcao_exercida];
        $this->inputsHelper()->select('funcao_exercida', $options);

        $resources = [ null => 'Nenhum',
        ...
        $options = ['label' => Portabilis_String_Utils::toLatin1('Tipo do vínculo'), 'resources' => $resources, 'value' => $this->tipo_vinculo, 'required' => false];
        $this->inputsHelper()->select('tipo_vinculo', $options);
        $this->inputsHelper()->checkbox(
        'permite_lancar_faltas_componente',
                                    ['label' => Portabilis_String_Utils::toLatin1('Professor de área específica?'),
