...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        if ($registro['data']) {
            $this->addDetalhe([ Portabilis_String_Utils::toLatin1('Data da distribui̤̣o'), Portabilis_Date_Utils::pgSQLToBr($registro['data']) ]);
        }
        ...
        if (dbBool($registro['kit_completo'])) {
            ...
            $this->addDetalhe([ 'Recebeu kit completo', Portabilis_String_Utils::toLatin1('Ṇo')]);

            $this->addDetalhe([ Portabilis_String_Utils::toLatin1('Quantidade de agasalhos (jaqueta e cal̤a)'), $registro['agasalho_qtd'] ?: '0' ]);
            ...
            $this->addDetalhe([ Portabilis_String_Utils::toLatin1('Quantidade de t̻nis'), $registro['tenis_qtd'] ?: '0' ]);
        }
