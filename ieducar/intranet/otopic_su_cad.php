...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $this->campoListaPesq('id_moderador', 'Incluir Super Usuário', ['Para procurar, clique na lupa ao lado'], '', 'pesquisa_funcionario_lst.php', '', false, '', '', null, null, '', false, $parametros->serializaCampos());
