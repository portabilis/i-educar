...
return new class extends clsCadastro {
    ...
    public $inputsMatrículasAtendidasPorConvenio = [
        ...
        'atendimento_educacional_especializado' => 'Atendimento educacional especializado',
        'ensino_regular_creche_parcial' => 'Ensino Regular - Creche - Parcial',
        'ensino_regular_creche_integral' => 'Ensino Regular - Creche - Integral',
        'ensino_regular_pre_escola_parcial' => 'Ensino Regular - Pré-escola - Parcial',
        'ensino_regular_pre_escola_integral' => 'Ensino Regular - Pré-escola - Integral',
        'ensino-regular_ensino_fundamental_anos_iniciais_parcial' => 'Ensino Regular - Ensino Fundamental - Anos Iniciais - Parcial',
        'ensino-regular_ensino_fundamental_anos_iniciais_integral' => 'Ensino Regular - Ensino Fundamental - Anos Iniciais - Integral',
        'ensino_regular_ensino_fundamental_anos_finais_parcial' => 'Ensino Regular - Ensino Fundamental - Anos Finais - Parcial',
        'ensino_regular_ensino_fundamental_anos_finais_integral' => 'Ensino Regular - Ensino Fundamental - Anos Finais - Integral',
        'ensino_regular_ensino_medio_anos_iniciais_parcial' => 'Ensino Regular - Ensino Médio - Anos Iniciais - Parcial',
        'ensino_regular_ensino_medio_anos_iniciais_integral' => 'Ensino Regular - Ensino Médio - Anos Iniciais - Integral',
        'educacao_especial_classe_especial_parcial' => 'Educação Especial - Classe especial - Parcial',
        'educacao_especial_classe_especial_integral' => 'Educação Especial - Classe especial - Integral',
        'educacao_de_jovens_e_adultos_ensino_fundamental' => 'Educação de Jovens e Adultos (EJA) - Ensino fundamental',
        'educacao_de_Jovens_e_adultos_Ensino médio' => 'Educação de Jovens e Adultos (EJA) - Ensino médio',
        'educacao_profissional_qualificacao_profissional_integrada_a_educaçã_de_jovens_e_adultos_no_ensino_fundamental_parcial' => 'Educação Profissional - Qualificação profissional - Integrada à educação de jovens e adultos no ensino fundamental - Parcial',
        'educacao_profissional_qualificacao_profissional_integrada_a_educaçã_de_jovens_e_adultos_no_ensino_fundamental_integral' => 'Educação Profissional - Qualificação profissional - Integrada à educação de jovens e adultos no ensino fundamental - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_integrada_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'Educação Profissional - Qualificação profissional técnica - Integrada à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnica_integrada_a_educacao_de_jovens_e_adultos_de_nivel_medio_integral' => 'Educação Profissional - Qualificação profissional técnica - Integrada à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'Educação Profissional - Qualificação profissional técnica - Concomitante à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_a_educacao_de_jovens_e_adultos_de_nivel_medio_Integral' => 'Educação Profissional - Qualificação profissional técnica - Concomitante à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_intercomplementar_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'educação Profissional - Qualificação profissional técnica - Concomitante intercomplementar à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_intercomplementar_a_educacao_de_jovens_e_adultos_de_nivel_medio_Integral' => 'Educação Profissional - Qualificação profissional técnica - Concomitante intercomplementar à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_integrada_ao_ensino_medio_parcial' => 'Educação Profissional - Qualificação profissional técnica - Integrada ao ensino médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnicaintegrada_ao_ensino_medio_integral' => 'Educação Profissional - Qualificação profissional técnica - Integrada ao ensino médio - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_ao_ensino_medio_parcial' => 'Educação Profissional - Qualificação profissional técnica - Concomitante ao ensino médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_ao_ensino_medio_integral' => 'Educação Profissional - Qualificação profissional técnica - Concomitante ao ensino médio - Integral',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_intercomplementar_ao_ensino_medio_parcial' => 'Educação Profissional - Qualificação profissional técnica - Concomitante intercomplementar ao ensino médio - Parcial',
        'educacao_profissional_qualificacao_profissional_tecnica_concomitante_intercomplementar_ao_ensino_medio_integral' => 'Educação Profissional - Qualificação profissional técnica - Concomitante intercomplementar ao ensino médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_integrada_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Integrada à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_integrada_a_educacao_de_jovens_e_adultos_de_nivel_medio_integral' => 'Educação Profissional - Educação profissional técnica de nível médio - Integrada à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_a_educacao_de_jovens_e_adultos_de_nivel_medio_integral' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_intercomplementar_a_educacao_de_jovens_e_adultos_de_nivel_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante intercomplementar à educação de jovens e adultos de nível médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_intercomplementar_a_educacao_de_jovens_e_adultos_de_nivel_medio_integral' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante intercomplementar à educação de jovens e adultos de nível médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_integrada_ao_ensino_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Integrada ao ensino médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_integrada_ao_ensino_medio_integral' => 'Educação Profissional - Educação profissional técnica de nível médio - Integrada ao ensino médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_ao_ensino_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante ao ensino médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_subsequente_ao_ensino_medio' => 'Educação Profissional - Educação profissional técnica de nível médio - Subsequente ao ensino médio',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_ao_ensino_medio_integral' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante ao ensino médio - Integral',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_intercomplementar_ao_ensino_medio_parcial' => 'Educação Profissional - Educação profissional técnica de nível médio - Concomitante intercomplementar ao ensino médio - Parcial',
        'educacao_profissional_educacao_profissional_tecnica_de_nivel_medio_concomitante_intercomplementar_ao_ensino_medio_integral' => 'Educaçao Profissional - Educação profissional técnica de nível médio - Concomitante intercomplementar ao ensino médio - Integral'
    ];
