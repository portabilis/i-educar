...
class indice extends clsDetalhe
{
    public function Gerar()
    {
        ...
        */
        ...
        $this->addDetalhe(['Nome', $detalhe['nm_grupo']]);
        $this->addDetalhe(['Data de Criação', date('d/m/Y', strtotime(substr($detalhe['data_cadastro'], 0, 19)))  ]);
...
class Listas extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Tópico', 'Responsável' , 'Status' ]);
        ...
        */
        ...
        if ($lista) {
            foreach ($lista as $topicos) {
                ...
                $this->addLinhas(["<a href='otopic_topicos_cad.php?cod_topico={$topicos['cod_topico']}&cod_grupo=$cod_grupo'>{$descricao}</a>", $nome, $status]);
            }
            $this->array_botao = ['Imprimir (Jato)', 'Imprimir (Laser)'];
            $this->array_botao_url = ["otopic_meus_grupos_imprime_topicos_sugeridos.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=jato", "otopic_meus_grupos_imprime_topicos_sugeridos.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=laser"];
        }
...
class Listas2 extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Tópico', 'Responsável']);
        ...
        if ($topico_finalizados) {
            ...
            if ($lista) {
                foreach ($lista as $topicos) {
                    ...
                    $detalhe = $obj->detalhe();
                    $nome = $detalhe['nome'];
                    $this->addLinhas(["{$descricao}", $nome]);
                }
                //pdf
                $this->array_botao = ['Imprimir (Jato)', 'Imprimir (Laser)'];
                $this->array_botao_url = ["otopic_meus_grupos_imprime_topicos_aguardando.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=jato", "otopic_meus_grupos_imprime_topicos_aguardando.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=laser"];
            }
        }
        ...
        */
        ...
        if ($topico_finalizados) {
            ...
            if ($lista) {
                ...
                //pdf
                $this->array_botao = ['Imprimir (Jato)', 'Imprimir (Laser)'];
                $this->array_botao_url = ["otopic_meus_grupos_imprime_topicos_finalizados.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=jato", "otopic_meus_grupos_imprime_topicos_finalizados.php?cod_membro=$cod_membro&cod_grupo=$cod_grupo&imprimir=laser"];
            }
        }
...
class lista_reunioes extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Descrição', 'Data Inicio', 'Data Fim', 'Status' ]);
        ...
        if ($lista) {
            foreach ($lista as $reuniao) {
                ...
                $this->addLinhas(["<a title='{$reuniao['descricao']}' href='otopic_reunioes_det.php?cod_reuniao={$reuniao['cod_reuniao']}&cod_grupo=$cod_grupo'>{$descricao}</a>", $data_inicio,$data_fim, $finalizada]);
            }
        }
