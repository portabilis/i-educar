...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Data', 'Objeto', 'Editar']);
        ...
        while ($db->ProximoRegistro()) {
            ...
            $this->addLinhas([ "<a href='licitacoes_finalizar_cad.php?id_licitacao=$id_licitacao'><img src='imagens/noticia.jpg' border=0>$data</a>", "<a href='licitacoes_finalizar_cad.php?id_licitacao=$id_licitacao'>$numero</a>", "<a href='licitacoes_funcionarios_cad.php?id_licitacao=$id_licitacao'>Clique aqui para Editar</a>" ]);
        }
