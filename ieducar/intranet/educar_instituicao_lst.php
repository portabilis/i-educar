...
return new class extends clsListagem {
    ...
    {
        $this->titulo = 'Institui&ccedil;ão - Listagem';

        foreach ($_GET as $var => $val) { // passa todos os valores obtidos no GET para atributos do objeto
            $this->$var = ($val === '') ? null: $val;
        }

        $this->addCabecalhos([ 'Nome da Institui&ccedil;ão' ]);

        // outros Filtros
        $this->campoTexto('nm_instituicao', 'Nome da Institui&ccedil;ão', $this->nm_instituicao, 30, 255, false);
