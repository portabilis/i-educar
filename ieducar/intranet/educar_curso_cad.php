...
return new class extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $script = "javascript:showExpansivelIframe(580, 280, 'educar_nivel_ensino_cad_pop.php?ref_cod_instituicao=' + document.getElementById('ref_cod_instituicao').value);";
        if ($this->ref_cod_instituicao) {
        ...
        $script = "javascript:showExpansivelIframe(520, 180, 'educar_tipo_ensino_cad_pop.php?ref_cod_instituicao=' + document.getElementById('ref_cod_instituicao').value);";
        if ($this->ref_cod_instituicao) {
        ...
        $script = "javascript:showExpansivelIframe(520, 180, 'educar_tipo_regime_cad_pop.php?ref_cod_instituicao=' + document.getElementById('ref_cod_instituicao').value);";
