...
class indice extends clsCadastro
{
	...
	function renderHTML()
	{
		...
		$this->pdf->linha_relativa(810,  120, 0, 135);//fim
		...
		for ($ordem = 1; $ordem <= 22; $ordem++)//foreach de alunos
		{
			...
			$this->pdf->linha_relativa(285+($i*13), $base+($linha*13), 0, 13);//total

			$this->pdf->linha_relativa(810, $base+($linha*13), 0, 13);//fim
			$linha++;
		//}
		}
		//}
