...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
      ...
      'value'       => $this->observacao
        ...
        $this->campoTabelaInicio('notas', 'Notas', ['Disciplina','Nota','Faltas', '<p title="Informe a carga horária somente se a disciplina não pertencer à grade curricular do município.">C.H (?)</p>', 'Ordem', 'Dependência'], $this->historico_disciplinas);
