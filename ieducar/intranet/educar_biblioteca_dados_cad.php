                ...
                foreach ( $this->biblioteca_dia_semana as $key => $campo )
                {
                    if($campo)
                    {
                        foreach ($campo as $chave => $dias)
                        {
                            ...
                            {
                                $this->campoTextoInv( "dia_{$dias}", "", $this->dias_da_semana[$dias], 8, 8, false, false, false, "",
                                        "<a href='#' onclick=\"getElementById('excluir_dia_semana').value = '{$dias}'; getElementById('tipoacao').value = ''; "
