...
//		$this->campoRotulo( "bt_incluir_dia_semana", "Dia da Semana", "<a href='#' onclick=\"getElementById('incluir_dia_semana').value = 'S'; getElementById('tipoacao').value = ''; {$this->__nome}.submit();\"><img src='imagens/nvp_bot_incluir2.gif' title='Incluir' border=0></a>" );
        ...
        $this->campoRotulo("bt_incluir_feriadoNacional", "Feriados Nacionais Permanentes", "<a href='#' onclick=\"getElementById('incluir_feriados_nacionais').value = 'S'; getElementById('tipoacao').value = ''; {$this->__nome}.submit() ;\"><img src='imagens/nvp_bot_adiciona.gif' title='Incluir' border=0></a>");
