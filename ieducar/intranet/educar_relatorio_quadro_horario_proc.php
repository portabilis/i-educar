...
class indice extends clsCadastro
{
	...
	function addCabecalho()
	{
		...
		//titulo principal
		$this->pdf->escreve_relativo( "PREFEITURA COBRA TECNOLOGIA", 30, $this->page_y + 2, 535, 80, $fonte, 18, $corTexto, 'center' );

		//dados escola
		$this->pdf->escreve_relativo( "Instituição:  $this->nm_instituicao", 110, $this->page_y + 38, 400, 80, $fonte, 10, $corTexto, 'left' );
		$this->nm_escola ? $this->pdf->escreve_relativo( "Escola:  {$this->nm_escola}",127, $this->page_y + 48, 300, 80, $fonte, 10, $corTexto, 'left' ) : NULL;

		//titulo
		$this->pdf->escreve_relativo( "Quadro de Horários - $this->ano", 30, $this->page_y +23, 535, 80, $fonte, 12, $corTexto, 'center' );
