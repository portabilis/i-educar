          ...
          <td class="fundoCalendarioTopo" style="padding:0px;">SAB</td>
            ...
            if (class_exists('clsProcesso')) {
                ...
                if ($lista_pastas) {
                    ...
                    $lista_minhas_pastas = $obj_encaminha->lista_cod_processos(
              false,
            false,
              false,
              false,
            ...
            false,
              ...
              $lista_pastas
                    ...
                    if ($lista_minhas_pastas) {
                        ...
                        $lista_processos_ativos = $obj_processo->lista_cod(
                false,
                false,
              false,
                false,
            ...
            for ($i=1; $i <= date('t', mktime(0, 0, 0, $mes, 1, $ano)); $i++) {
                ...
                if (class_exists('clsEncaminha')) {
                    ...
                    $lista_encaminha = $objEncaminha->lista_cod_encaminha(
              false,
              false,
            false,
              false,
            ...
            false,
              ...
              $dataAmanha
                    ...
                    if ($lista_encaminha) {
                        $lista_encaminha = $obj_encaminha->lista(
                false,
                false,
                false,
                false,
              ...
              $dataAtual,
                ...
                $encaminha['ref_versao_processo']) {
                    ...
                    $encaminha['ref_cod_juris_processo'],
                  $encaminha['ref_versao_processo']
                );
