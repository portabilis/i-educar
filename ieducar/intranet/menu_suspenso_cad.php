        ...
        if (isset($_POST['id_deletar']) && $_POST['id_deletar'] != '' && $_POST['editando'] == 2) {
            ...
            if ($_POST['editando'] == 1) {
              ...
              || ($_POST['tt_menu'] != '' && $_POST['ord_menu']  == '0')
                    ...
                    $_SESSION['menu_suspenso'][$_POST['editar']]  = [
