...
class indice extends clsCadastro
{
  ...
  public function addCabecalho()
  {
    ...
    // Dados escola
    $this->pdf->escreve_relativo("Instituição:$this->nm_instituicao", 120, 50,
      300, 80, $fonte, 10, $corTexto, 'left');
    $this->pdf->escreve_relativo("Escola:{$this->nm_escola}",136, 62, 300, 80,
      $fonte, 10, $corTexto, 'left');
    $this->pdf->escreve_relativo("Curso:{$this->nm_escola}\t\t\t\t\tTurma:", 136,
      74, 300, 80, $fonte, 10, $corTexto, 'left');
    $this->pdf->escreve_relativo("Aluno:Haissam yebahi do brasil",136, 86, 300,
