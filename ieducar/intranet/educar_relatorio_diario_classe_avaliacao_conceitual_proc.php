...
class indice extends clsCadastro
{
	...
	function desenhaLinhasVertical()
	{
		...
		for($linha = 0;$linha <$this->total-1;$linha++)
		{
			...
			$this->pdf->escreve_relativo( $linha + 1,$reta_ano_x , 145, $incremental, 80, $fonte, 7, $corTexto, 'center' );
...
CNA = Competência Não Avaliada", 36,750, 200, 50, $fonte, 7, $corTexto, 'left' );
		...
		$this->pdf->escreve_relativo( "Data: ____/____/_______", 200,810, 100, 50, $fonte, 7, $corTexto, 'left' );

		//$this->pdf->escreve_relativo( "Assinatura do Professor(a)", 450,660, 100, 50, $fonte, 7, $corTexto, 'left' );
		//$this->pdf->escreve_relativo( "Assinatura do Diretor(a)", 68,520, 100, 50, $fonte, 7, $corTexto, 'left' );
		$this->pdf->escreve_relativo( "Assinatura do Professor(a)", 450,780, 100, 50, $fonte, 7, $corTexto, 'left' );
