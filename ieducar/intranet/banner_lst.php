...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Banner', 'Prioridade']);
        ...
        while ($db->ProximoRegistro()) {
            ...
            $this->addLinhas(["<a href='banner_det.php?cod_portal_banner=$cod_portal_banner'><img src='fotos/imgs/{$caminho}' border=\"0\" width=\"149\"></a>", "<img src='imagens/grafico_hp.png' border=0 height='8' width='{$prioridade}'><br>{$link}<br>{$porcentagem}"]);
        }
