...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Rela&ccedil;&atilde;o Alfabetizados e não Alfabetizados" );
		$this->processoAp = "930";
	}
}
...
document.formcadastro.action = 'educar_relatorio_alfabetizados_proc.php';
