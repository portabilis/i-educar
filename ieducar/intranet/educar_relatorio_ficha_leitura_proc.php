...
/**
 * Ficha de leitura para o primeiro ano regular.
 *
...
class indice extends clsCadastro
{
  ...
  public function addCabecalho()
  {
    ...
    $this->pdf->escreve_relativo($titulo, 30, 30, 535,
      80, $fonte, 18, $corTexto, 'center');
    $this->pdf->escreve_relativo(date("d/m/Y"), 500, 30, 100, 80, $fonte,
      12, $corTexto, 'left');
