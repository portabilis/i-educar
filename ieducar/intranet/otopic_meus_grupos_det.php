...
class Listas extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Nome', 'e-mail', 'Ramal', 'Função' ]);
        ...
        foreach ($lista as $pessoas) {
            ...
            $this->addLinhas(["<a href='otopic_membro_det.php?cod_membro={$detalhe['idpes']}&cod_grupo={$cod_grupo}'>{$detalhe['nome']}</a>",$detalhe['email'],$detFuncionario['ramal'], $funcao]);
        }
