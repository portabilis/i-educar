    ...
    public function Gerar()
    {
        ...
        if ($lista_menu) {
            foreach ($lista_menu as $menu) {
                $this->addLinhas(["<img src='imagens/noticia.jpg' border=0> <a href='menu_suspenso_det.php?cod_menu={$menu['cod_tutormenu']}'>{$menu['nm_tutormenu']}</a>"]);
            }
        }
