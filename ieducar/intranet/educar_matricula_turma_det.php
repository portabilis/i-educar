    ...
    public function Gerar()
    {
      ...
      null,
        ...
        if (!$this->possuiEnturmacaoTurmaDestino) {
            $this->addDetalhe(['Data da enturmação', '<input onkeypress="formataData(this,event);" value="'.date('d/m/Y').'" class="geral" type="text" name="data_enturmacao" id="data_enturmacao" size="9" maxlength="10"/>']);
        }
