...
class indice extends clsDetalhe
{
    public function Gerar()
    {
        ...
        if ($db->ProximoRegistro()) {
            ...
            $this->addDetalhe(['IP externo', $ip_e ]);
            $this->addDetalhe(['IP interno', $ip_i ]);
            $this->addDetalhe(['Pagina', $pagina ]);
            $this->addDetalhe(['Extra', $variaveis ]);
            $this->addDetalhe(['Data', date('d/m/Y H:i', strtotime(substr($data_hora, 0, 19))) ]);
        }
