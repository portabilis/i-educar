    ...
    public function Gerar()
    {
        ...
        if (isset($_GET['selecionar'])) {
            ...
            if ($nivelAtual < 5) {
                ...
                $lista = [];
                $lista = [0=>'Selecione', 's'=>'Secretaria', 'a'=>'Altarquia', 'f'=>'Fundação'];
                ...
                $sec = [ 'Para procurar, clique na lupa ao lado' ];
                if ($this->secretario) {
                    $cls_pessoa = new clsPessoa_($this->secretario);
                    $detalhe_pessoa = $cls_pessoa->detalhe();
                    $sec = [ 'Para procurar, clique na lupa ao lado', $this->secretario => $detalhe_pessoa['nome'] ];
                }
