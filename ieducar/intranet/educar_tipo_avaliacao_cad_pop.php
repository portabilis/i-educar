	...
	function Novo()
	{
		...
		if ( $this->nm_tipo && $this->valores_avaliacao && $this->incluir != 'S' && empty( $this->excluir_ ) ) {
			...
			if( $cadastrou )
			{
				...
				echo "<script>
						if (parent.document.getElementById('ref_cod_tipo_avaliacao').disabled)
							parent.document.getElementById('ref_cod_tipo_avaliacao').options[0] = new Option('Selecione um tipo de avaliação', '', false, false);
						parent.document.getElementById('ref_cod_tipo_avaliacao').options[parent.document.getElementById('ref_cod_tipo_avaliacao').options.length] = new Option('$this->nm_tipo', '$cadastrou', false, false);
						parent.document.getElementById('ref_cod_tipo_avaliacao').value = '$cadastrou';
						parent.document.getElementById('ref_cod_tipo_avaliacao').disabled = false;
