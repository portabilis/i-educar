...
class indice extends clsDetalhe
{
	...
	//fotos
		...
		if($lista_fotos)
		{
			...
			$tabela .= "<tr bgcolor='#ccdce6'><th>Foto</th><th>Data</th><th width='100%'>Tï¿½tulo</th><th width='70'>Excluir</th></tr>";
		...
		if($lista_fotos)
		{
			...
			if($lista_fotos)
			{
				...
				$tabela .= "<table cellpadding=\"2\" cellspacing=\"2\" border=\"0\" align=\"left\" width='100%'>";
				$tabela .= "<tr bgcolor='#ccdce6'><th>Foto</th><th>Data</th><th width='60%'>Tï¿½tulo</th><th width='70'>Excluir</th></tr>";
