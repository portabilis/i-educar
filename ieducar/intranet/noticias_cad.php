...
{
    public $id_noticia_altera;
    public $id_pessoa;
    public $titulo;
    public $data_noticia;
    public $data_noticia2;
    public $descricao;
    //TIPOS
    public $id_tipo_deletar;
    public $id_tipo;
    public $qtd_tipos;
    public $todos_tipos;
    //FOTOS
    public $id_foto_deletar;
    public $id_foto;
    public $qtd_fotos;
    public $todas_fotos;
    //NOTICIAS
    public $id_noticia_deletar;
    public $id_noticia;
    public $qtd_noticias;
    public $todas_noticias;
    //ARQUIVOS
    public $arquivo_deletar;
    public $caminho_arquivo;
    public $qtd_arquivos;
    public $todos_arquivos;
    public $nome_arquivo;
    public $nome_;
    public $sobrenome;
                ...
                if ($caminho != '') {
                    ...
                    if ($continua =='true') {
                        ...
                        if (!empty($this->todos_arquivos)) {
                            $this->todos_arquivos[] = [$caminho,$nome_arquivo,$novocaminho];
                        } else {
                            $this->todos_arquivos[1] = [$caminho,$nome_arquivo,$novocaminho];
                        }
                    }
                }
            } elseif (!empty($_FILES['caminho_arquivo']['name'])) {
        ...
        if (@$_GET['id_noticia'] && $this->titulo=='') {
            ...
            while ($db->ProximoRegistro()) {
                ...
                if ($tipo == 'A') {
                    ...
                    if (!empty($this->todos_arquivos)) {
                        $this->todos_arquivos[] = ["tmp/{$this->qtd_arquivos}.tmp",$nome_arquivo,$caminho];
                    } else {
                        $this->todos_arquivos[1] = ["tmp/{$this->qtd_arquivos}.tmp",$nome_arquivo,$caminho];
                    }
                }
            }
        } else {
