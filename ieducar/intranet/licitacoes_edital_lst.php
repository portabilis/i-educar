...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Número da Licitação', 'Modalidade', 'Versão', 'Atualizado em' ]);
        ...
        while ($db->ProximoRegistro()) {
            ...
            $this->addLinhas([ "<a href='licitacoes_edital_det.php?cod_edital=$cod_compras_editais_editais'><img src='imagens/noticia.jpg' border=0>$numero_licitacao</a>", "<a href='licitacoes_edital_det.php?cod_edital=$cod_compras_editais_editais'>$nm_modalidade</a>", $versao, date('d/m/Y H:i', strtotime(substr($data_hora, 0, 19))) ]);
        }
