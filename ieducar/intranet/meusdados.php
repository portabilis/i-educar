...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		list ($this->p_ddd_telefone_1, $this->p_ddd_telefone_2, $this->p_ddd_telefone_fax, $this->p_ddd_telefone_mov) = $this->null2empityStr( array( $this->p_ddd_telefone_1, $this->p_ddd_telefone_2, $this->p_ddd_telefone_fax, $this->p_ddd_telefone_mov ) );
		...
		{
		  //$this->campoCep("cep_","CEP", int2CEP( $this->cep ),true,"-","&nbsp;<img src=\"imagens/lupa.png\" border=\"0\" onclick=\"pesquisa_valores_f('pesquisa_cep.php', 'enderecos')\" style=\"cursor: hand;\">",true);
		...
		{
		  //$this->campoCep("cep_","CEP",int2CEP( $this->cep ),true,"-","&nbsp;<img src=\"imagens/lupa.png\" border=\"0\" onclick=\"pesquisa_valores_f('pesquisa_cep.php', 'enderecos')\" style=\"cursor: hand;\">",false);
  			$this->campoCep("cep_", "CEP", $this->cep, true, "-", "&nbsp;<img id='lupa' src=\"imagens/lupa.png\" border=\"0\" onclick=\"showExpansivel( 500,500, '<iframe name=\'miolo\' id=\'miolo\' frameborder=\'0\' height=\'100%\' width=\'500\' marginheight=\'0\' marginwidth=\'0\' src=\'educar_pesquisa_cep_log_bairro.php?campo1=bairro&campo2=idbai&campo3=cep&campo4=logradouro&campo5=idlog&campo6=ref_sigla_uf&campo7=cidade&campo8=ref_idtlog&campo9=isEnderecoExterno&campo10=cep_&campo11=sigla_uf&campo12=idtlog&campo13=id_cidade\'></iframe>');\">", $disabled);
		...
		else
		{
			...
			$this->campoTextoInv( "numero", "Nï¿½mero",  $this->numero, "10", "10", false );
		...
		$this->campoTexto( "p_ddd_telefone_2", "DDD Telefone 2",  $this->p_ddd_telefone_2, "2", "2", false );
		$this->campoTexto( "p_telefone_2", "Telefone",  $this->p_telefone_2, "10", "15", false );
		$this->campoTexto( "p_ddd_telefone_mov", "DDD Celular",  $this->p_ddd_telefone_mov, "2", "2", false );
		$this->campoTexto( "p_telefone_mov", "Celular",  $this->p_telefone_mov, "10", "15", false );
