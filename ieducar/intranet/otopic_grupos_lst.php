...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Grupo', 'Data de crica&ccedil;&atilde;o', 'N&uacute;mero de Membros']);
        ...
        if ($listaGrupos) {
            foreach ($listaGrupos as $grupo) {
                ...
                $this->addLinhas(["<img src='imagens/noticia.jpg' border=0><a href='otopic_grupos_det.php?cod_grupos={$cod_grupo}'>$nm_grupo</a>", $data_cadastro, $totalPessoas]);
            }
        }
