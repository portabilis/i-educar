            ...
            if ($caminho != '') {
                ...
                if ($continua =='true') {
                    ...
                    if (!empty($this->todos_arquivos)) {
                        $this->todos_arquivos[] = [$caminho,$novocaminho];
                    } else {
                        $this->todos_arquivos[1] = [$caminho,$novocaminho];
                    }
                }
            }
        } else {
        ...
        if (@$_GET['cod_jornal'] =='') {
            ...
            if ($this->edicao == '') {
                ...
                if ($db->ProximoRegistro()) {
                    ...
                    if ($teste[2] < 10) {
                        $this->data_inicial = '0'.$this->data_inicial;
                    }

                    $teste = explode('/', $this->data_final);
                    if ($teste[2] < 10) {
                        $this->data_final = '0'.$this->data_final;
                    }
                    $db_tmp = new clsBanco();
                    ...
                    while ($db_tmp->ProximoRegistro()) {
                        ...
                        if (!empty($this->todos_arquivos)) {
                            $this->todos_arquivos[] = ['tmp/'.date('Y-m-d')."-{$this->qtd_arquivos}.tmp",$caminho,'s'];
                        } else {
                            $this->todos_arquivos[1] = ['tmp/'.date('Y-m-d')."-{$this->qtd_arquivos}.tmp",$caminho,'s'];
                        }
                    }
                    $this->edicao =$edicao;
                } else {
