					...
					for ( $c = 1; $c <= 7; $c++ )
					{
						...
						if ( is_array( $resultado ) )
						{
							foreach ( $resultado as $registro )
							{
								...
								$det_servidor   = array_shift($obj_servidor->lista($registro['ref_servidor'],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,true));
...
function envia( obj, var1, var2, var3, var4, var5, var6, var7 )
{
	if ( obj.innerHTML )
	{
		document.formcadastro.action = 'educar_quadro_horario_horarios_cad.php?ref_cod_turma=' + var1 + '&ref_cod_serie=' + var2 + '&ref_cod_curso=' + var3 + '&ref_cod_escola=' + var4 + '&ref_cod_instituicao=' + var5 + '&ref_cod_quadro_horario=' + var6 + '&dia_semana=' + var7;
