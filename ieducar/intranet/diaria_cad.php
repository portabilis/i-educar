...
class indice extends clsCadastro
{
    ...
    public $ref_funcionario;
    public $conta_corrente;
    public $agencia;
    public $banco;
    public $dotacao_orcamentaria;
    public $objetivo;
    public $data_partida;
    public $data_chegada;
    public $hora_partida;
    ...
    public function Gerar()
    {
        ...
        $this->campoLista('estadual', 'Estadual', [ 'N&atilde;o', 'Sim' ], $this->estadual, 'diaria_carrega_valores();');
