...
class PDF_Unicode extends PDF_Chinese
{
  ...
  public function __construct($layout='P', $uom='mm', $papersize='A4', $charset = 'UTF-8')
  {
      FPDF::__construct($layout, $uom, $papersize);
      //$this->FPDF ('L', 'mm', 'A4');
      $this->charset = strtoupper(str_replace('-', '', $charset));
      $this->isUnicode = in_array($this->charset, ['UTF8', 'UTF16', 'UCS2']);
  }

    public function AddUniCNShwFont($family='Uni', $name='PMingLiU')  // name for Kai font is DFKai-SB
    {
    ...
    public function AddUniCNSFont($family='Uni', $name='PMingLiU')
    {
