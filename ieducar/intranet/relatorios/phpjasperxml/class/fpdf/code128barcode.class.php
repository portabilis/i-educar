...
class code128barcode
{
    ...
    public $checksum = 0;
    public $error_level = E_USER_WARNING;
    public $error = false;
    public $unoptimized = false;
    public $nozerofill = false;
    ...
    public $_CODEB = [];
    public $_CODEC = [];
    public $_specialcodes = [];
    public $_startcodes = [];
    public $_barcode = [];
    public $_checksum = 0;
    public $_count = 0;
    public $_current_code = '_CODEB';
    public $_actual_code = '_CODEB';
    // }}}
    ...
    public function __construct()
    {
        ...
        $this->_specialcodes = ['FNC1' => ['_CODEA' => 102,
                                                      '_CODEB' => 102,
                                                      '_CODEC' => 102],
                                      'FNC2' => ['_CODEA' => 97,
                                                      '_CODEB' => 97],
    ...
    public function specialchar($specialchar)
    {
        if (!array_key_exists(0, $this->_barcode)) {
            $this->start('_CODEB');
        }
    ...
    public function add_checksum($code)
    {
        if ($this->_count === 0) {
            $this->_checksum = $code;
        } else {
