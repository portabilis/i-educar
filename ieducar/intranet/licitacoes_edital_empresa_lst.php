...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Empresa', 'CNPJ ou CPF', 'e-mail' ]);
        ...
        while ($db->ProximoRegistro()) {
            ...
            $this->addLinhas([ "<a href='licitacoes_edital_empresa_det.php?cod_empresa=$cod_compras_editais_empresa'><img src='imagens/noticia.jpg' border=0>$nm_empresa</a>", "<a href='licitacoes_edital_empresa_det.php?cod_empresa=$cod_compras_editais_empresa'>$cnpj</a>", $email ]);
        }
