...
function acao2()
{
	...
	showExpansivelImprimir(400, 200,'',[], "Alunos Matriculados - Sint&eacute;tico");
...
document.formcadastro.action = 'educar_relatorio_alunos_matriculados_sintetico_proc.php';
