...
class indice extends clsCadastro
{
    ...
    public $todos_moderadores;
    public $qtd_moderadores;
    public $id_moderador;
    public $id_moderador_deletar;
    //Pessoas(membros)
    public $listaPessoas;
    ...
    public function Gerar()
    {
        ...
        $this->campoListaPesq('id_moderador', 'Incluir Moderador', [ 'Para procurar, clique na lupa ao lado' ], $this->ref_cod_pessoa_fj, 'pesquisa_funcionario_lst.php', '', false, '', '', null, null, '', false, $parametros->serializaCampos());
