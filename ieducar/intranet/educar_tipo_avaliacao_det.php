...
class indice extends clsDetalhe
{
	...
	function Gerar()
	{
		...
		if( is_numeric( $registro["conceitual"] ) ) {
			$conceitual = ( $registro["conceitual"] == 0 ) ? "Não" : "Sim";
		...
		if($lst)
		{
			$tabela = "<TABLE>
					       <TR align=center>
					           ...
					           <TD bgcolor=#A1B3BD><B>Nota Mín.</B></TD>
					           <TD bgcolor=#A1B3BD><B>Nota Máx.</B></TD>
					       </TR>";
			$cont = 0;
			...
			$this->addDetalhe( array( "Tipo de Avaliação (Valores)", $tabela ) );
		}
