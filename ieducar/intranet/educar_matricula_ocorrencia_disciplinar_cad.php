...
class indice extends clsCadastro
{
	...
	function Excluir()
	{
		...
		$obj = new clsPmieducarMatriculaOcorrenciaDisciplinar($this->ref_cod_matricula, $this->ref_cod_tipo_ocorrencia_disciplinar, $this->sequencial, $this->pessoa_logada, $this->pessoa_logada, $this->observacao, Portabilis_Date_Utils::brToPgSQL($this->data_cadastro), $this->data_exclusao, 0);
		$excluiu = $obj->excluir();
		if( $excluiu )
		{
