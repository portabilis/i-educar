...
class indice extends clsDetalhe
{
    public function Gerar()
    {
        ...
        if ($db->ProximoRegistro()) {
            ...
            $this->addDetalhe(['Responsável', $pessoa ]);
            $this->addDetalhe(['Data', date('d/m/Y H:i', strtotime(substr($data, 0, 19))) ]);
            $this->addDetalhe(['Nome', $nome]);
            $this->addDetalhe(['Descrição', $descricao]);
            $this->addDetalhe(['Arquivo', "<a href='arquivos/$caminho''><img src='/intranet/imagens/nvp_icon_{$tipo}.gif' border='0'></a>"]);
        }
