                ...
                foreach ($lst_pessoa as $pessoa) {
                    ...
                    if ($parametros->getPessoaEditar() == 'S') {
                        if ($parametros->getPessoaTela() == 'frame') {
                            $this->addLinhas([ "<a href='pesquisa_pessoa_cad.php?pessoa=F&cod={$pessoa['idpes']}&ref_cod_sistema=".$parametros->getCodSistema()."'>{$pessoa['cpf']}</a>", "<a href='pesquisa_pessoa_cad.php?pessoa=F&cod={$pessoa['idpes']}&ref_cod_sistema=".$parametros->getCodSistema()."'>{$pessoa['nome']}</a>" ]);
                        } else {
            ...
            if ($lst_pessoa) {
                foreach ($lst_pessoa as $pessoa) {
                    ...
                    if ($campos['edita']['permitir'] == 'S') {
                        if ($parametros->getPessoaTela() == 'frame') {
                            $this->addLinhas([ "<a href='pesquisa_pessoa_cad.php?pessoa=J&cod={$pessoa['idpes']}'>{$pessoa['cnpj']}</a>", "<a href='pesquisa_pessoa_cad.php?pessoa=J&cod={$pessoa['idpes']}'>{$pessoa['nome']}</a>" ]);
                        } else {
            ...
            if ($lst_pessoa) {
                foreach ($lst_pessoa as $pessoa) {
                    ...
                    if ($parametros->getPessoaEditar() == 'S') {
                        if ($parametros->getPessoaTela() == 'frame') {
                            if ($det_pes['tipo'] == 'J') {
                                $this->addLinhas([ "<a href='pesquisa_pessoa_cad.php?pessoa={$det_pes['tipo']}&cod={$pessoa['idpes']}'>{$pessoa['cnpj']}</a>", "<a href='pesquisa_pessoa_cad.php?pessoa={$det_pes['tipo']}&cod={$pessoa['idpes']}'>{$pessoa['nome']}</a>" ]);
                            } elseif ($det_pes['tipo'] == 'F') {
                                $this->addLinhas([ "<a href='pesquisa_pessoa_cad.php?pessoa={$det_pes['tipo']}&cod={$pessoa['idpes']}&ref_cod_sistema=".$parametros->getCodSistema()."'>{$pessoa['cpf']}</a>", "<a href='pesquisa_pessoa_cad.php?pessoa={$det_pes['tipo']}&cod={$pessoa['idpes']}&ref_cod_sistema=".$parametros->getCodSistema()."'>{$pessoa['nome']}</a>" ]);
                            }
                        } else {
                            if ($det_pes['tipo'] == 'J') {
                                $this->addLinhas([ "<a href='javascript:void( 0 );' onclick=\"javascript:{$funcao}\">{$pessoa['cnpj']}</a>", "<a href='javascript:void( 0 );' onclick=\"javascript:{$funcao}\">{$pessoa['nome']}</a>" ]);
...
//              $lst_pessoa = $obj_pessoa->lista( null, null, $iniciolimit, $limite, false, $parametros->getCodSistema() );
            ...
            if ($lst_pessoa) {
                foreach ($lst_pessoa as $pessoa) {
                    ...
                    if ($parametros->getPessoaEditar() == 'S') {
                        if ($parametros->getPessoaTela() == 'frame') {
                            $this->addLinhas([ "<a href='pesquisa_pessoa_cad.php?pessoa=F&cod={$pessoa['idpes']}'>{$pessoa['matricula']}</a>", "<a href='pesquisa_pessoa_cad.php?pessoa=F&cod={$pessoa['idpes']}&ref_cod_sistema=".$parametros->getCodSistema()."'>{$pessoa['nome']}</a>" ]);
                        } else {
