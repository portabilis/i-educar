...
class indice extends clsDetalhe
{
    public function Gerar()
    {
        ...
        if ($db->ProximoRegistro()) {
            ...
            $this->addDetalhe(['Responsável', $responsavel]);
            ...
            $this->addDetalhe(['Descri&ccedil;&atilde;o', $descricao]);
            ...
            while ($db->ProximoRegistro()) {
                ...
                if ($tipo =='N') {
                    ...
                    $this->addDetalhe(['Noticias Vinculadas', "<img src='imagens/noticia.jpg' border=0>&nbsp;<a href='noticias_det.php?id_noticia=$cod'><strong>$titulo</strong></a>"]);
                ...
                if ($tipo =='A') {
                    $this->addDetalhe(['Arquivos Vinculados', "<strong>$nome_arquivo</strong> &nbsp; <a href='$caminho'><img  width='20' height='20' src='imagens/noticia.jpg' border=0></a>"]);
                }
            }
        }
