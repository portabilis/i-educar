...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Data', 'Edi&ccedil;&atilde;o', 'Tamanho(em Kb)']);
        ...
        while ($db->ProximoRegistro()) {
            ...
            if ($data_inicial != $data_final) {
                $this->addLinhas(["<a href='jornal_det.php?cod_jornal={$cod}'><img src='imagens/noticia.jpg' border=0>$data_inicial à $data_final</a>", $edicao, $tamanho]);
            } else {
                $this->addLinhas([ "<a href='jornal_det.php?cod_jornal={$cod}'><img src='imagens/noticia.jpg' border=0>$data_final</a>", $edicao, $tamanho]);
            }
        }
