        ...
        if ($this->nm_setor || $this->sgl_setor) {
            ...
            if ($lista) {
                foreach ($lista as $key=>$valor) {
                    ...
                    $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor=$cod_setor>$str</a>"]);
                    $total++;
                }
            }
        } else {
            ...
            if ($listaSetores0) {
                foreach ($listaSetores0 as $key0=>$valor0) {
                    $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor={$valor0['cod_setor']}>$valor0[sgl_setor]</a>"]);
                    $total++;
                    ...
                    if ($listaSetores1) {
                        foreach ($listaSetores1 as $key1=>$valor1) {
                            ...
                            $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor=$valor1[cod_setor]>$a</a></font>"]);
                            $total++;
                            ...
                            if ($listaSetores2) {
                                foreach ($listaSetores2 as $key2=>$valor2) {
                                    ...
                                    $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor=$valor2[cod_setor]>$a</a></font>"]);
                                    $total++;
                                    ...
                                    if ($listaSetores3) {
                                        foreach ($listaSetores3 as $key3=>$valor3) {
                                            ...
                                            $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor=$valor3[cod_setor]>$a</a></font>"]);
                                            $total++;
                                            ...
                                            if ($listaSetores4) {
                                                foreach ($listaSetores4 as $key4=>$valor4) {
                                                    ...
                                                    $this->addLinhas(["<a href=oprot_setor_det.php?cod_setor=$valor4[cod_setor]>$a</a></font>"]);
                                                    $total++;
                                                }
                                            }
                                        }
