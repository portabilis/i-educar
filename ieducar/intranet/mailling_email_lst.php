...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        while ($db->ProximoRegistro()) {
            ...
            $this->addLinhas(["<img src='imagens/noticia.jpg' border=0>&nbsp;&nbsp;<a href='mailling_email_det.php?id_email=$cod_email'>$nome</a>", "<a href='mailling_email_det.php?id_email=$cod_email'>$email</a>"]);
        }
