...
class indice extends clsCadastro
{
    ...
    public function Enturmar()
    {
        ...
        if ($qtd_alunos_new < $saldo_turma) {
            ...
            null,
            null,
          $dado_matricula_old[0]['ref_ref_cod_escola'],
            $dado_matricula_old[0]['ref_ref_cod_serie'],
            null,
          $this->pessoa_logada,
            $dado_matricula_old[0]['ref_cod_aluno'],
            3,
            null,
            null,
            1,
            $dado_matricula_old[0]['ano'],
          1,
            null,
            null,
            null,
            null,
            $dado_matricula_old[0]['ref_cod_curso'],
          null,
            1,
            $datah
        );
    ...
    public function existeVagasDisponíveis()
    {
        $dependencia = $this->dependencia == 'on';
        if (!$dependencia) {
