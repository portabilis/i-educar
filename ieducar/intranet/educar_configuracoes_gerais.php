...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $options = ['label' => 'Mostrar código INEP nas telas de cadastro de aluno?',
        'value' => $this->mostrar_codigo_inep_aluno,
        'required' => true,
    ];
        $this->inputsHelper()->booleanSelect('mostrar_codigo_inep_aluno', $options);

        $options = ['label' => 'Campo "Justificativa para a falta de documentação" no cadastro de alunos deve ser obrigatório?',
