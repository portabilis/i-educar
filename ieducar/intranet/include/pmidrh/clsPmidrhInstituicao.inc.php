...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 14/12/2006 16:29 pelo gerador automatico de classes
*/

require_once('include/pmidrh/geral.inc.php');

class clsPmidrhInstituicao
{
     ...
     * @return object
     */
    public function __construct($cod_instituicao = null, $ref_funcionario_exc = null, $ref_funcionario_cad = null, $nm_instituicao = null, $data_cadastro = null, $data_exclusao = null, $ativo = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmidrh.';
        $this->_tabela = "{$this->_schema}instituicao";

        $this->_campos_lista = $this->_todos_campos = 'cod_instituicao, ref_funcionario_exc, ref_funcionario_cad, nm_instituicao, data_cadastro, data_exclusao, ativo';
    ...
    {
        if (is_numeric($this->ref_funcionario_cad) && is_string($this->nm_instituicao)) {
            $db = new clsBanco();
    ...
    {
        if (is_numeric($this->cod_instituicao) && is_numeric($this->ref_funcionario_exc)) {
            $db = new clsBanco();
            $set = '';
     ...
     * @param string str_nm_instituicao
     ...
     * @return array
     */
    public function lista($int_ref_funcionario_exc = null, $int_ref_funcionario_cad = null, $str_nm_instituicao = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $bool_ativo = null)
    {
    ...
    public function detalhe()
    {
        if (is_numeric($this->cod_instituicao)) {
            $db = new clsBanco();
            $db->Consulta("SELECT {$this->_todos_campos} FROM {$this->_tabela} WHERE cod_instituicao = '{$this->cod_instituicao}'");
            $db->ProximoRegistro();
