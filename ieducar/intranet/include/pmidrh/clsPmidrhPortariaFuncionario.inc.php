...
class clsPmidrhPortariaFuncionario
{
     ...
     * @return object
     */
    public function __construct($ref_cod_portaria = null, $sequencial = null, $ref_ref_cod_pessoa_fj = null, $nm_funcionario = null, $cpf = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmidrh.';
     ...
     * @return array
     */
    public function lista($int_ref_cod_portaria = null, $int_ref_ref_cod_pessoa_fj = null, $str_nm_funcionario = null, $int_cpf = null)
    {
