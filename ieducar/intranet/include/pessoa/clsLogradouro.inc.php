...
class clsLogradouro
{
     ...
     * @return Array
     */
    function lista( $str_idtlog=false, $str_nome=false, $int_idmun=false, $str_geom=false, $str_ident_oficial=false, $int_limite_ini=0, $int_limite_qtd=20, $str_orderBy = false, $int_idlog=false )
    {
...
/**
     ...
     * @return Array
     */
    function listamun( $str_idtlog=false, $str_nome=false, $int_idmun_que_papo_e_esse=false, $int_idmun=false, $str_geom=false, $str_ident_oficial=false, $int_limite_ini=0, $int_limite_qtd=20, $str_orderBy = false )
    {
        // verificacoes de filtros a serem usados
        $whereAnd = "WHERE ";
        if( is_string( $str_idtlog ) )
