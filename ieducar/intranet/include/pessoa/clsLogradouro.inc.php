...
class clsLogradouro
{
     ...
     * @return Array
     */
    public function listamun($str_idtlog = false, $str_nome = false, $__int_id = false, $int_idmun = false, $str_geom = false, $str_ident_oficial = false, $int_limite_ini = 0, $int_limite_qtd = 20, $str_orderBy = false)
    {
        $whereAnd = 'WHERE ';
        if (is_string($str_idtlog)) {
