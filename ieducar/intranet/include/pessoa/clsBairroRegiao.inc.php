...
class clsBairroRegiao
{
     ...
     */
    public function __construct($int_ref_cod_regiao = false, $int_ref_idbai=false)
    {
     ...
     * @return bool
     */
    public function exclui($cod_regiao_excluir = false)
    {
     ...
     * @return Array
     */
    public function lista($ref_cod_regiao = false, $int_limite_ini=false, $int_limite_qtd=false, $str_orderBy = false)
    {
