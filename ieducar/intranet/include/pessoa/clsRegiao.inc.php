...
class clsRegiao
{
     ...
     */
    public function __construct($int_cod_regiao = false, $str_nm_regiao=false)
    {
     ...
     * @return Array
     */
    public function lista($str_nm_regiao = false, $int_limite_ini=false, $int_limite_qtd=false, $str_orderBy = false)
    {
