...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 09/11/2006 14:41 pelo gerador automatico de classes
*/

//require_once( "include/cadastro/geral.inc.php" );
...
class clsCadastroFisicaRaca
{
	 ...
	 * @return object
	 */
	function clsCadastroFisicaRaca( $ref_idpes = null, $ref_cod_raca = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_ref_idpes = null, $int_ref_cod_raca = null  )
	{
