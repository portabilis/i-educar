...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    class clsGraficoSubdividido
    {
        ...
        public $maxVal;
        public $maxWidth;
        public $deslocamentos;
        public $charIdentacao = ' &nbsp; -';
        public $titulo;
        public $totalGeral;

        public function __construct($arrayValores, $maxVal, $maxWidth, $titulo = false, $totalGeral=false)
        {
        ...
        public function getLinha($arr, $nivel, $nmPai)
        {
            $retorno = '';
