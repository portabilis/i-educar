        ...
        foreach ($arr_campos as $nome => $componente) {
            ...
            ($componente[0] == 'linha_preta') {
                ...
                if ($campo_tabela && false) {
                    ...
                    $retorno .= "<tr id='tr_$nome' {$name} $style><td class='$classe' valign='top'><span class='form'><label for='$nome'>$campo</label></span>{$obrigatorio}</td><td class='$classe' valign='top'><span class='form'>\n";
                } elseif (!$foiDuplo) {
                    if ($campo == '-:') {
                        ...
                        $retorno .= "<tr id='tr_$nome' {$name} $style><td class='$classe' valign='top'><span class='form'><label for='$nome'>$campo</label></span>{$obrigatorio}{$explicacao}</td><td class='$classe' valign='top'><span class='form'>\n";
                    }
                } elseif ($tipo) {
