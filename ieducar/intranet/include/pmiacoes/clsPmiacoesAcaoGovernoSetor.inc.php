...
class clsPmiacoesAcaoGovernoSetor
{
     ...
     * @return object
     */
    public function __construct($ref_cod_acao_governo = null, $ref_cod_setor = null, $ref_funcionario_cad = null, $data_cadastro = null)
    {
        $db = new clsBanco();
     ...
     * @return object
     */
    public function clsPmiacoesAcaoGovernoSetor($ref_cod_acao_governo = null, $ref_cod_setor = null, $ref_funcionario_cad = null, $data_cadastro = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmiacoes.';
        $this->_tabela = "{$this->_schema}acao_governo_setor";
     ...
     * @return array
     */
    public function lista($int_ref_cod_acao_governo = null, $int_ref_cod_setor = null, $int_ref_funcionario_cad = null, $str_data_cadastro_inicio = null, $str_data_cadastro_fim = null)
    {
