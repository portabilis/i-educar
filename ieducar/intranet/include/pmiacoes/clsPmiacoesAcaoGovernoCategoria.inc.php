...
class clsPmiacoesAcaoGovernoCategoria
{
     ...
     * @return object
     */
    public function __construct($ref_cod_categoria = null, $ref_cod_acao_governo = null)
    {
        $db = new clsBanco();
     ...
     * @return object
     */
    public function clsPmiacoesAcaoGovernoCategoria($ref_cod_categoria = null, $ref_cod_acao_governo = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmiacoes.';
        $this->_tabela = "{$this->_schema}acao_governo_categoria";
     ...
     * @return array
     */
    public function lista($int_ref_cod_categoria = null, $int_ref_cod_acao_governo = null)
    {
