...
class clsPmiacoesSecretariaResponsavel
{
     ...
     * @return object
     */
    public function __construct($ref_cod_setor = null, $ref_cod_funcionario_cad = null, $data_cadastro = null)
    {
        $db = new clsBanco();
     ...
     * @return object
     */
    public function clsPmiacoesSecretariaResponsavel($ref_cod_setor = null, $ref_cod_funcionario_cad = null, $data_cadastro = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmiacoes.';
        $this->_tabela = "{$this->_schema}secretaria_responsavel";
    ...
    {
        if (is_numeric($this->ref_cod_setor) && is_numeric($this->ref_cod_funcionario_cad)) {
            $db = new clsBanco();
    ...
    public function edita()
    {
        if (is_numeric($this->ref_cod_setor)) {
            ...
            if ($set) {
                $db->Consulta("UPDATE {$this->_tabela} SET $set WHERE ref_cod_setor = '{$this->ref_cod_setor}'");
     ...
     * @return array
     */
    public function lista($int_ref_cod_setor = null, $int_ref_cod_funcionario_cad = null, $str_data_cadastro_inicio = null, $str_data_cadastro_fim = null)
    {
    ...
    public function detalhe()
    {
        if (is_numeric($this->ref_cod_setor)) {
            $db = new clsBanco();
            $db->Consulta("SELECT {$this->_todos_campos} FROM {$this->_tabela} WHERE ref_cod_setor = '{$this->ref_cod_setor}'");
            $db->ProximoRegistro();
