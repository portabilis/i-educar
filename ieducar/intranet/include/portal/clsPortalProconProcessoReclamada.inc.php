...
class clsPortalProconProcessoReclamada
{
     ...
     * @return object
     */
    public function __construct($ref_cod_processo = null, $ref_idpes = null)
    {
        $db = new clsBanco();
        $this->_schema = 'portal.';
     ...
     * @return array
     */
    public function lista($int_ref_cod_processo = null)
    {
    ...
    public function excluirTudo($ref_cod_processo)
    {
        if (is_numeric($ref_cod_processo)) {
