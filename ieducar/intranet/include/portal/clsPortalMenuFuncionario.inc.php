...
class clsPortalMenuFuncionario
{
     ...
     * @return object
     */
    public function __construct($ref_ref_cod_pessoa_fj = null, $cadastra = null, $exclui = null, $ref_cod_menu_submenu = null)
    {
        $db = new clsBanco();
        $this->_schema = 'portal.';
     ...
     * @return array
     */
    public function lista($int_cadastra = null, $int_exclui = null, $int_ref_ref_cod_pessoa_fj = null)
    {
     ...
     * @return array
     */
    public function listaSubmenu($int_ref_ref_cod_pessoa_fj = null, $int_ref_cod_menu_menu = null, $str_order_by = null)
    {
...
//              $resultado[] = $tupla[$this->_campos_lista];
     ...
     * @return bool
     */
    public function excluirTodos($cod_menu)
    {
