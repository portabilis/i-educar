...
class clsModulesVeiculo
{
  ...
  function clsModulesVeiculo($cod_veiculo = NULL, $descricao = NULL, $placa = NULL, $renavam = NULL,
                             ...
                             $ano_modelo = NULL, $passageiros = NULL, $malha = NULL, $ref_cod_classificacao = NULL,
                             ...
                             $ref_cod_motorista = NULL, $observacao = NULL )
  {
    ...
    $this->_campos_lista = $this->_todos_campos = " cod_veiculo, descricao, placa, renavam, chassi, marca, ano_fabricacao, 
       ano_modelo, passageiros, malha, ref_cod_classificacao, exclusivo_transporte_escolar, 
   ...
   if (is_string($ano_modelo)) {
    ...
    if (is_numeric($ref_cod_classificacao)) {
      $this->ref_cod_classificacao = $ref_cod_classificacao;
    }
  ...
  function cadastra()
  {
   ...
   if (is_string($ano_modelo)) {
    ...
    if (is_numeric($ref_cod_classificacao)) {
        $campos .= "{$gruda}ref_cod_classificacao";
        $valores .= "{$gruda}'{$this->ref_cod_classificacao}'";
        $gruda = ", ";
    }
  ...
  function edita()
  {
   ...
   if (is_string($ano_modelo)) {
    ...
    if (is_numeric($ref_cod_classificacao)) {
        $set .= "{$gruda}ref_cod_classificacao = '{$this->ref_cod_classificacao}'";
        $gruda = ", ";
    }
  ...
  function lista($cod_veiculo = NULL, $descricao = NULL,
    ...
    $ref_cod_motorista = NULL, $ref_cod_empresa_transporte_escolar = NULL)
  {
  ...
  function detalhe()
  {
    if (is_numeric($this->cod_veiculo)) {
      $db = new clsBanco();
      $db->Consulta("SELECT {$this->_todos_campos} FROM {$this->_tabela} WHERE cod_veiculo = '{$this->cod_veiculo}'");
      $db->ProximoRegistro();
      return $db->Tupla();
    }
