...
class clsModulesComponenteMinistradoBNCCEspecificacaoAee extends Model {
    public $id;
    ...
    public function __construct(
        ...
        $this->_tabela = "{$this->_schema}conteudo_ministrado_bncc_especificacao_aee";

        $this->_from = "
            modules.conteudo_ministrado_bncc_especificacao_aee as cmbe
        ";
    ...
    public function lista($conteudo_ministrado_id) {
        if (is_numeric($conteudo_ministrado_id)) {
            ...
            while($db->ProximoRegistro()) {
                ...
                $obj = new clsModulesPlanejamentoAulaBNCCEspecificacaoAee($cmbe['planejamento_aula_bncc_especificacao_id']);
                $bncc_especificacao_id = $obj->detalhe()[0]['bncc_especificacao_id'];

                $obj = new clsModulesBNCCEspecificacaoAee($bncc_especificacao_id);
