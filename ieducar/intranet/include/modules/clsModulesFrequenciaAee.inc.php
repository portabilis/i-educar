...
class clsModulesFrequenciaAee extends Model {
    public $id;
    public $ano;
    public $ref_cod_ins;
    ...
    public function cadastra() {
        if ($this->data && is_numeric($this->ref_cod_turma) && is_numeric($this->ref_cod_serie) && $this->etapa_sequencial) {
            ...
            if ($this->alunos) {
                ...
                $db->Consulta("INSERT INTO modules.frequencia_aluno_aee ( $campos ) VALUES $valores");
    ...
    public function detalhe () {
        if (is_numeric($this->id)) {
            ...
            $db->Consulta("
                ...
                FROM
                    modules.frequencia_aluno_aee f
                GROUP BY
                    f.ref_frequencia
                HAVING
    ...
    public function pegaMatriculasApartirFrequenciaId ($id = null) {
        ...
        $db->Consulta("
            ...
            FROM
                modules.frequencia_aee f 
            JOIN modules.frequencia_aluno_aee a
