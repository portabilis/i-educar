...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    class clsGraficoDiario
    {
        ...
        public $datafim = [];
        public $dataAtual = [];
        public $mostraWeekend;
        public $legenda;
        public $titulo;
        public $mesAtual = 0;
        public $maxVal = 0;
        public $altura = 200;
        public $timeDataAtual;
        public $mesesExtenso = [ '', 'Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro' ];
        public $ultimoDiaMes = [ 0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 ];
        public $diasSemana = [ 'Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado' ];

        public function __construct($arrayValores, $dataInicio, $dataFim=false, $titulo=false, $legenda=false, $mostraWeekend=false)
        {
        ...
        public function insereMedia($ultimoDia, $somaVals, $diasUteis)
        {
            $retorno = '';
        ...
        public function preencheGrafVazio($ini, $fim)
        {
            $retorno = '';
            for ($i = $ini; $i < $fim; $i++) {
        ...
        public function geraHTML($insideTemplate=false)
        {
            $diasArray = [];
            $somaVals = [ 0, 0, 0, 0 ];
            $diasUteis = 0;
