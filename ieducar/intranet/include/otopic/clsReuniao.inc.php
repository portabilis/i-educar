...
{
    public $cod_reuniao;
    public $ref_moderador;
    public $ref_grupos_moderador;
    public $descricao;
    public $email_enviado;
    public $data_inicio_marcado;
    public $data_fim_marcado;
     ...
     */
    public function __construct($int_cod_reuniao = false, $int_ref_moderador = false, $int_ref_grupos_moderador = false, $str_descricao = false, $bool_email_enviado = false, $date_data_inicio_marcado = false, $date_data_fim_marcado = false, $date_data_inicio_real = false, $date_date_fim_real = false, $int_publica = false)
    {
     ...
     * @return Array
     */
    public function lista($int_ref_moderador = false, $int_ref_grupos_moderador =false, $str_ordenacao = false, $date_data_inicio_marcado_ini=false, $date_data_inicio_marcado_fim = false, $int_limite_ini = false, $int_limite_qtd = false, $bool_nao_finalizadas = false, $bool_finalizadas = false, $int_publica = false, $date_data_inicio_real_ini=false, $date_data_inicio_real_fim = false)
    {
     ...
     * @return Array
     */
    public function listaReunioesData($ref_moderador, $inicio, $fim, $x, $y, $bool_nao_finalizada = false, $bool_finalizada = false)
    {
