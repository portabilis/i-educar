...
{
    public $cod_pessoa_observacao;
    public $ref_cod_pessoa_auxiliar;
    public $ref_idpes;
    public $obs;
    public $data_edicao;
     ...
     * @return Object
     */
    public function __construct($int_cod_pessoa_observacao = null, $int_ref_cod_pessoa_auxiliar = null, $int_ref_idpes = null, $str_obs = null, $str_data_edicao = null)
    {
...
//          echo "UPDATE {$this->tabela} SET $set WHERE cod_pessoa_observacao = '{$this->cod_pessoa_observacao}'"; die();
     ...
     * @return Array
     */
    public function setcampos_lista($str_campos)
    {
     ...
     * @return void
     */
    public function resetcampos_lista()
    {
     ...
     * @return Array
     */
    public function lista($int_ref_cod_pessoa_auxiliar = null, $int_ref_idpes = null, $str_obs = null, $int_limite_ini = false, $int_limite_qtd = false, $str_order_by = false, $str_data_edicao_ini = false, $str_data_edicao_fim = false)
    {
