...
{
    public $ref_cod_topico;
    public $ref_cod_reuniao;
    public $parecer;
    public $finalizado;
    public $data_parecer;

    public $tabela = 'pmiotopic.topicoreuniao';
     ...
     * @return Object
     */
    public function __construct($int_ref_cod_topico = false, $int_ref_cod_reuniao = false, $str_parecer= false, $str_finalizado = false, $str_data_parecer = false)
    {
    ...
    public function exclui_todos($cod_reuniao)
    {
        if ($cod_reuniao) {
            $db = new clsBanco();
     ...
     * @return Array
     */
    public function lista($str_parecer= false, $str_finalizado = false, $str_data_parecer_ini = false, $str_data_parecer_fim = false, $int_limite_ini = 0, $int_limite_qtd = 20, $str_order_by = false, $int_cod_reuniao = false, $int_ref_cod_topico =false)
    {
