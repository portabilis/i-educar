...
{
    public $ref_idpes;
    public $ref_cod_grupos;
    public $ref_pessoa_exc;
    public $ref_grupos_exc;
    public $ref_pessoa_cad;
    public $ref_grupos_cad;
    public $ativo;
    public $data_cadastro;
    public $data_exclusao;
    public $ref_cod_auxiliar_cad;
    public $ref_ref_cod_atendimento_cad;
     ...
     */
    public function __construct($int_ref_idpes = false, $int_ref_cod_grupos = false, $int_ref_pessoa_cad = false, $int_ref_pessoa_exc = false, $int_ref_grupos_cad = false, $int_ref_grupos_exc = false, $ativo=1, $int_ref_cod_auxiliar_cad = false, $int_ref_ref_cod_antendimento_cad = false)
    {
     ...
     * @return Array
     */
    public function lista($int_ref_idpes = false, $int_ref_cod_grupos = false, $str_ordenacao = false, $int_ativo=1, $int_limite_ini = false, $int_limite_qtd = false, $int_ref_cod_auxiliar_cad = false, $int_ref_ref_cod_atendimento_cad = false)
    {
    ...
    public function meusGrupos($int_ref_idpes, $str_ordenacao = false, $int_ativo=1, $int_limite_ini = false, $int_limite_qtd = false, $array_isin = false)
    {
        $orderBy = '';
        if (is_string($str_ordenacao)) {
            $orderBy = "ORDER BY $str_ordenacao";
    ...
    public function pessoasGrupo($int_ref_cod_grupo, $str_ordenacao = false, $int_ativo=1, $int_limite_ini = false, $int_limite_qtd = false)
    {
        $orderBy = '';
        $WHERE = '';
        if (is_string($str_ordenacao)) {
