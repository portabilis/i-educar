...
class clsAtendimento
{
    ...
    public $tabela = 'pmiotopic.atendimento';
     ...
     * @return Object
     */
    public function __construct($int_cod_atendimento = false, $int_ref_ref_cod_pessoa_exc = false, $int_ref_ref_cod_pessoa_cad = false, $str_descricao = false, $str_data_cadastro = false, $str_data_exclusao = false, $int_ativo = false)
    {
