...
class clsPessoaAuxiliarTelefone
{
     ...
     * @return Object
     */
    public function __construct($int_ref_cod_pessoa_auxiliar = null, $int_ddd = null, $int_fone = null)
    {
     ...
     * @return Array
     */
    public function lista($int_ref_cod_pessoa_auxiliar = false, $int_ddd = false, $int_fone = false, $int_limite_ini = false, $int_limite_qtd = false, $str_order_by = false)
    {
