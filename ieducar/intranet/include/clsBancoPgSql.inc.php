...
abstract class clsBancoSQL_
{
     ...
     * @return bool
     */
    public function savePoint($strSavePointName = false)
    {
        if ($this->transactionBlock) {
            if ($strSavePointName) {
     ...
     * @return bool
     */
    public function rollBack($strSavePointName = false)
    {
        if ($this->transactionBlock) {
     ...
     * @param bool   $getError
     */
    public function Interrompe($appErrorMsg, $getError = false)
    {
