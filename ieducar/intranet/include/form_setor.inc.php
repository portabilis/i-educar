...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    if ($this->setor_0) {
        ...
        if (is_array($lista) && count($lista)) {
            ...
            $lista1 = [ 'Nenhum setor filho para este setor' ];
        }
    } else {
        $lista1 = $listaVazia;
    }
    ...
    if ($this->setor_1) {
        ...
        if (is_array($lista) && count($lista)) {
            ...
            $lista2 = [ 'Nenhum setor filho para este setor' ];
        }
    } else {
        $lista2 = $listaVazia;
    }
    ...
    if ($this->setor_2) {
        ...
        if (is_array($lista) && count($lista)) {
            ...
            $lista3 = [ 'Nenhum setor filho para este setor' ];
        }
    } else {
        $lista3 = $listaVazia;
    }
    ...
    if (! $this->setor_3) {
        ...
        if (is_array($lista) && count($lista)) {
            ...
            $lista4 = [ 'Nenhum setor filho para este setor' ];
        }
    } else {
        $lista4 = $listaVazia;
    }
