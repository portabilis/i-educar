...
class clsPDF
{
	...
	function clsPDF($nome, $titulo, $tamanhoFolha, $palavrasChaves, $depurar=false, $reder=true)
	{
		$this->nome = $nome;
		$this->titulo = $titulo;
	...
	function OpenPage()
	{
		...
		{
			//constru&ccedil;&atilde;o de pagina normal
			$this->ClosePage();
			$this->numeroPagina++;
	...
	function MakeTamPage($tamanhoFolha)
	{
		...
		switch($tamanhoFolha)
		{
			case 'A0':              $this->largura  = 2380.0; $this->altura = 3368.0; break;
			case 'A1':              $this->largura  = 1684.0; $this->altura = 2380.0; break;
			case 'A2':              $this->largura  = 1190.0; $this->altura = 1684.0; break;
			case 'A3':              $this->largura  = 842.0;  $this->altura = 1190.0; break;
			case 'A4':              $this->largura  = 595.0;  $this->altura = 842.0;  break;
			case 'A4h':             $this->largura  = 595.0;  $this->altura = 842.0;  break;
			case 'A5':              $this->largura  = 421.0;  $this->altura = 595.0;  break;
			case 'A6':              $this->largura  = 297.0;  $this->altura = 421.0;  break;
			case 'B5':              $this->largura  = 501.0;  $this->altura = 709.0;  break;
			case 'letter':			$this->largura  = 612.0;  $this->altura = 792.0;  break;
			case 'ledger':			$this->largura  = 1224.0; $this->altura = 792.0;  break;
			case 'p11x17':			$this->largura  = 792.0;  $this->altura = 1224.0; break;
		}
		if ($this->depurar)
		{
	...
	function SetFont($fonte, $tamanho)
	{
		...
		switch ($fonte)
		{
			case 'normal':			$f_user = 'Courier';					break;
//			case 'arial':			$f_user = 'Arial';						break;
			case 'courier':			$f_user = 'Courier-Bold';				break;
			case 'courierItalico':	$f_user = 'Courier-BoldOblique';		break;
			case 'normalItalico':	$f_user = 'Helvetica-BoldOblique';		break;
			case 'times':			$f_user = 'Times-Bold';					break;
			case 'timesItalico':	$f_user = 'Times-BoldItalic';			break;
			case 'symbol':			$f_user = 'ZapfDingbats';				break;
			case 'monospaced':		$f_user = 'monospaced';					break;
//			case 'timesNormal':		$f_user = 'Times-New-Roman';			break;
			default:				$f_user = 'Helvetica-Bold';
		}
	 ...
	 * @param string $color2
	 */
	function quadrado_absoluto($x_topleft, $y_topleft, $x_bottomright, $y_bottomright, $linha=0.1, $color="#000000", $color2="#FFFFFF" )
	{
		$altura = $y_bottomright - $y_topleft;
		$largura = $x_bottomright - $x_topleft;
		$this->quadrado_relativo( $x_topleft, $y_topleft, $largura, $altura, $linha, $color, $color2 );
	}
	 ...
	 * @param string $color2
	 */
	function quadrado_relativo($x_topleft, $y_topleft, $largura, $altura, $linha=0.1, $color="#000000", $color2="#FFFFFF" )
	{
		$this->Shape( 'ret', $x_topleft, $this->altura - $y_topleft - $altura, $largura, $altura, $linha, $color, $color2 );
	}

	function Line( $xo, $yo, $x, $y, $linha=2.001, $color1="#000000", $color2="#000000", $teck=true, $teck2 = true)
	{
		if ($teck2)
		{
			$this->SetLine( $linha );
	 ...
	 * @param string $color2
	 */
	function linha_absoluta($x_topleft, $y_topleft, $x_bottomright, $y_bottomright, $linha=0.1, $color="#000000", $color2="#FFFFFF" )
	{
		$this->Line( $x_topleft, $this->altura - $y_topleft, $x_bottomright, $this->altura - $y_bottomright, $linha, $color, $color2 );
	}
	 ...
	 * @param string $color2
	 */
	function linha_relativa($x_topleft, $y_topleft, $largura, $altura, $linha=0.1, $color="#000000", $color2="#FFFFFF" )
	{
		$this->Line( $x_topleft, $this->altura - $y_topleft, $x_topleft + $largura, $this->altura - $y_topleft - $altura, $linha, $color, $color2 );
	}
	 ...
	 * @param string $local
	 */
	function escreve_relativo( $texto, $x_topleft, $y_topleft, $largura, $altura, $fonte='arial', $tamanho='10', $color="#000000", $align='left' )
	{
		$this->Write( $texto, $x_topleft, $y_topleft + $altura, $largura, $altura, $fonte, $tamanho, $color, $align );
	}
	 ...
	 * @param string $local
	 */
	function escreve_absoluto( $texto, $x_topleft, $y_topleft, $x_bottomright, $y_bottomright, $fonte='arial', $tamanho='10', $color="#000000", $align='left' )
	{
		$this->Write( $texto, $x_topleft, $y_bottomright, $x_bottomright - $x_topleft, $y_bottomright - $y_topleft, $fonte, $tamanho, $color, $align );
//		echo "{$x_topleft}, {$y_bottomright}, " . ( $x_bottomright - $x_topleft ) . ", " . ( $y_bottomright - $y_topleft ) . "<br>";
	}
	...
	function PagAgenda($texto, $dia_semana_v, $data_atual_v, $lembrete)
	{
		...
		$this->Write($texto, 40, $this->altura-30, $this->largura-80, $this->altura-180, 'courier', 10, "#333333", "left");
