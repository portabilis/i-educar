...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    class clsGrafico
    {
        ...
        *****************************************************************************************/
        public $arrValores;
        public $intTamGrafico;
        public $titulo;
        public $legConteudo;
        public $align;
        public $globalAlign;

        public function __construct($valor, $titulo='Gráfico', $tgrafico=600, $legConteudo='')
        {
        ...
        public function setAlign($strAlign)
        {
            $this->align = $strAlign;
        }
        public function setGlobalAlign($strAlign)
        {
         ...
         */
        public function graficoBarraHor()
        {
    ...
    <body>';
         ...
         *
         */
        public function graficoBarraVer()
        {
            $valor =  $this->arrValores;
            $tgrafico = $this->intTamGrafico;
            $titulo = $this->titulo;
