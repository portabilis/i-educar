...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 22/08/2006 10:04 pelo gerador automatico de classes
*/

require_once( "include/pmieducar/geral.inc.php" );

class clsPmieducarEscolaRedeEnsino
{
	 ...
	 * @return object
	 */
	function clsPmieducarEscolaRedeEnsino( $cod_escola_rede_ensino = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_rede = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $ref_cod_instituicao = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_cod_escola_rede_ensino = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_rede = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null, $int_ref_cod_instituicao = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_escola_rede_ensino = '{$this->cod_escola_rede_ensino}'" );
		return true;
		*/
