...
class clsPmieducarCalendarioAnotacao
{
	 ...
	 * @return array
	 */
	function lista( $int_cod_calendario_anotacao = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_anotacao = null, $str_descricao = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_calendario_anotacao = '{$this->cod_calendario_anotacao}'" );
		return true;
		*/
