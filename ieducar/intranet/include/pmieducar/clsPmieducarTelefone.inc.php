...
class clsPmieducarTelefone
{
	 ...
	 * @return array
	 */
	function lista( $int_ref_cod_pessoa_educ = null, $int_tipo = null, $int_ddd = null, $int_fone = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE ref_cod_pessoa_educ = '{$this->ref_cod_pessoa_educ}' AND tipo = '{$this->tipo}'" );
		return true;
		*/
