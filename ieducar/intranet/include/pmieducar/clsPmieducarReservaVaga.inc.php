...
class clsPmieducarReservaVaga
{
	 ...
	 * @return object
	 */
	function clsPmieducarReservaVaga( $cod_reserva_vaga = null, $ref_ref_cod_escola = null, $ref_ref_cod_serie = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $ref_cod_aluno = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $nm_aluno = null, $cpf_responsavel = null )
	{
		$db = new clsBanco();
	...
	function cadastra()
	{
		if( is_numeric( $this->ref_ref_cod_escola ) && is_numeric( $this->ref_ref_cod_serie ) && is_numeric( $this->ref_usuario_cad ) && (is_numeric( $this->ref_cod_aluno ) || ( is_numeric($this->cpf_responsavel) && is_string($this->nm_aluno))))
		{
			$db = new clsBanco();
	...
	function edita()
	{
		if( is_numeric( $this->cod_reserva_vaga ) /*&& is_numeric( $this->ref_usuario_exc )*/ )
		{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_reserva_vaga = '{$this->cod_reserva_vaga}'" );
		return true;
		*/
