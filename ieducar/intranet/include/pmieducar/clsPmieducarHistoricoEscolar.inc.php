...
class clsPmieducarHistoricoEscolar extends Model
{
    ...
    public function insereComponenteMediaGeral($sequencial)
    {
        if ($this->sequencial && $this->ref_cod_aluno) {
            ...
            $sql = "INSERT INTO pmieducar.historico_disciplinas (sequencial, ref_ref_cod_aluno, ref_sequencial, nm_disciplina, nota) values ({$sequencial}, {$this->ref_cod_aluno}, {$this->sequencial}, 'Media Geral' , {$mediaGeral});";
