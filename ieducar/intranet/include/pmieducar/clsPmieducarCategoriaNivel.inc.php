...
class clsPmieducarCategoriaNivel
{
	 ...
	 * Construtor (PHP 4)
	 *
	 * @param integer cod_categoria_nivel
	 * @param integer ref_usuario_exc
	 * @param integer ref_usuario_cad
	 * @param string nm_categoria_nivel
	 ...
	 * @return object
	 */
	function clsPmieducarCategoriaNivel( $cod_categoria_nivel = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_categoria_nivel = null, $data_cadastro = null, $data_exclusao = null, $ativo = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_cod_categoria_nivel = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_categoria_nivel = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $bool_ativo = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_categoria_nivel = '{$this->cod_categoria_nivel}'" );
		return true;
		*/
