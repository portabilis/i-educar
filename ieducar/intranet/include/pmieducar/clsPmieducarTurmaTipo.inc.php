...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 02/08/2006 11:30 pelo gerador automatico de classes
*/

require_once( "include/pmieducar/geral.inc.php" );

class clsPmieducarTurmaTipo
{
	var $cod_turma_tipo;
	var $ref_usuario_exc;
	var $ref_usuario_cad;
	 ...
	 * @return object
	 */
	function clsPmieducarTurmaTipo( $cod_turma_tipo = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_tipo = null, $sgl_tipo = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $ref_cod_instituicao = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_cod_turma_tipo = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_tipo = null, $str_sgl_tipo = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null, $int_ref_cod_instituicao = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_turma_tipo = '{$this->cod_turma_tipo}'" );
		return true;
		*/
