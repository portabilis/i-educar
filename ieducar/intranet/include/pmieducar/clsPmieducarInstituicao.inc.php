...
class clsPmieducarInstituicao
{
  ...
  function clsPmieducarInstituicao($cod_instituicao = NULL, $ref_usuario_exc = NULL,
    ...
    $percentagem_maxima_ocupacao_salas = NULL, $quantidade_alunos_metro_quadrado = NULL, $auditar_notas = NULL)
  {
    $db = new clsBanco();
  ...
  function cadastra()
  {
      ...
      is_numeric($this->ativo) && is_string($this->nm_instituicao))
    {
      ...
      if (dbBool($this->auditar_notas)) {
        $campos .= "{$gruda}auditar_notas";
        $valores .= "{$gruda} true ";
        $gruda = ", ";
      }else{
        $campos .= "{$gruda}auditar_notas";
  ...
  function edita()
  {
    if (is_numeric($this->cod_instituicao)) {
      ...
      if (dbBool($this->auditar_notas)) {
        $set .= "{$gruda}auditar_notas = true ";
        $gruda = ", ";
      }else{
        $set .= "{$gruda}auditar_notas = false ";
        $gruda = ", ";
      }
