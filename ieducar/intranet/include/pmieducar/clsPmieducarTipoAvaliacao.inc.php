...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 23/06/2006 17:35 pelo gerador automatico de classes
*/
...
class clsPmieducarTipoAvaliacao
{
	 ...
	 * @return object
	 */
	function clsPmieducarTipoAvaliacao( $cod_tipo_avaliacao = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_tipo = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $conceitual = null, $ref_cod_instituicao = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_cod_tipo_avaliacao = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_tipo = null, $date_data_cadastro = null, $date_data_exclusao = null, $int_ativo = null, $int_conceitual = null, $int_ref_cod_instituicao = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_tipo_avaliacao = '{$this->cod_tipo_avaliacao}'" );
		return true;
		*/
