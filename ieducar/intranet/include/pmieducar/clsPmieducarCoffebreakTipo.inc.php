...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 26/06/2006 09:28 pelo gerador automatico de classes
*/

require_once( "include/pmieducar/geral.inc.php" );

class clsPmieducarCoffebreakTipo
{
	 ...
	 * @return array
	 */
	function lista( $int_cod_coffebreak_tipo = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_tipo = null, $str_desc_tipo = null, $int_custo_unitario = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_coffebreak_tipo = '{$this->cod_coffebreak_tipo}'" );
		return true;
		*/
