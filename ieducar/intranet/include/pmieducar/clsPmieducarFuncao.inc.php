...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 03/08/2006 14:34 pelo gerador automatico de classes
*/
...
class clsPmieducarFuncao
{
	 ...
	 * @return object
	 */
	function clsPmieducarFuncao( $cod_funcao = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_funcao = null, $abreviatura = null, $professor = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $ref_cod_instituicao = null )
	{
		$db = new clsBanco();
...
//			$db->Consulta( "SELECT {$this->_todos_campos} FROM {$this->_tabela} WHERE cod_funcao = '{$this->cod_funcao}' AND ref_cod_instituicao = '{$this->ref_cod_instituicao}'" );
			$db->ProximoRegistro();
			return $db->Tupla();
		}
		return false;
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_funcao = '{$this->cod_funcao}'" );
		return true;
		*/
