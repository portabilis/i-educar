...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	if ($get_curso)
	{
		...
		$this->campoLista( "ref_cod_curso", "Curso", $opcoes_curso, $this->ref_cod_curso,null,null,null,null,true,$curso_obrigatorio );
	}
...
//					$obj_escola_curso->setOrderby("ref_cod_curso ASC");
		...
		if($exibe_campo_lista_curso_escola /*&& ! isset($sem_padrao)*/)
