...
class clsPmieducarTipoOcorrenciaDisciplinar
{
	 ...
	 * @return array
	 */
	function lista( $int_cod_tipo_ocorrencia_disciplinar = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_tipo = null, $str_descricao = null, $int_max_ocorrencias = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null, $int_ref_cod_instituicao = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_tipo_ocorrencia_disciplinar = '{$this->cod_tipo_ocorrencia_disciplinar}'" );
		return true;
		*/
