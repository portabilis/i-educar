...
* @author Prefeitura Municipal de Itajaí
*
* Criado em 26/06/2006 09:54 pelo gerador automatico de classes
*/

require_once( "include/pmieducar/geral.inc.php" );

class clsPmieducarDisciplinaTopico
{
	 ...
	 * @return object
	 */
	function clsPmieducarDisciplinaTopico( $cod_disciplina_topico = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_topico = null, $desc_topico = null, $data_cadastro = null, $data_exclusao = null, $ativo = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_cod_disciplina_topico = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $str_nm_topico = null, $str_desc_topico = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_disciplina_topico = '{$this->cod_disciplina_topico}'" );
		return true;
		*/
