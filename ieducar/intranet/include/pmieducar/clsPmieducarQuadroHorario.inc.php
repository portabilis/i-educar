...
class clsPmieducarQuadroHorario
{
	 ...
	 * @return array
	 */
	function lista( $int_cod_quadro_horario = null, $int_ref_usuario_exc = null, $int_ref_usuario_cad = null, $int_ref_cod_turma = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_quadro_horario = '{$this->cod_quadro_horario}'" );
		return true;
		*/
