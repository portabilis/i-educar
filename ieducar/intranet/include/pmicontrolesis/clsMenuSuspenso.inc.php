...
class clsMenuSuspenso
{
    ...
    public function __construct(
      $cod_menu = false,
      $ref_cod_menu_submenu = false,
    $ref_cod_menu_pai = false,
      $tt_menu = false,
      $ref_cod_ico = false,
    $ord_menu = false,
      $caminho = false,
    ...
    public function lista(
      ...
      $int_ref_cod_menu_pai = false,
    $str_tt_menu = false,
      $str_ref_cod_ico = false,
      $int_ord_menu = false,
    $str_caminho = false,
      $str_alvo = false,
      $int_suprime_menu = false,
    $int_ref_cod_tutormenu = false,
     ...
     */
    public function listaNivel($ref_cod_tutormenu, $idpes)
    {
        $db = new clsBanco();
