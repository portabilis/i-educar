...
class clsPmicontrolesisPortais
{
    public $cod_portais;
     ...
     * @return object
     */
    public function __construct($cod_portais = null, $ref_cod_funcionario_cad = null, $ref_cod_funcionario_exc = null, $url = null, $caminho = null, $data_cadastro = null, $data_exclusao = null, $ativo = null, $title = null, $descricao = null)
    {
        $db = new clsBanco();
        $this->_schema = 'pmicontrolesis.';
        $this->_tabela = "{$this->_schema}portais";

        $this->_campos_lista = $this->_todos_campos = 'cod_portais, ref_cod_funcionario_cad, ref_cod_funcionario_exc, url, caminho, data_cadastro, data_exclusao, ativo, title, descricao';
        ...
        if (is_numeric($cod_portais)) {
            $this->cod_portais = $cod_portais;
        }
        if (is_string($url)) {
            $this->url = $url;
        }
    ...
    public function edita()
    {
        if (is_numeric($this->cod_portais)) {
            ...
            if ($set) {
                $db->Consulta("UPDATE {$this->_tabela} SET $set WHERE cod_portais = '{$this->cod_portais}'");
     ...
     * @return array
     */
    public function lista($int_cod_portais = null, $int_ref_cod_funcionario_cad = null, $int_ref_cod_funcionario_exc = null, $str_url = null, $str_caminho = null, $date_data_cadastro_ini = null, $date_data_cadastro_fim = null, $date_data_exclusao_ini = null, $date_data_exclusao_fim = null, $int_ativo = null, $str_title = null, $str_descricao = null)
    {
        ...
        if (is_numeric($int_cod_portais)) {
            $filtros .= "{$whereAnd} cod_portais = '{$int_cod_portais}'";
            $whereAnd = ' AND ';
        }
    ...
    public function detalhe()
    {
        if (is_numeric($this->cod_portais)) {
            $db = new clsBanco();
            $db->Consulta("SELECT {$this->_todos_campos} FROM {$this->_tabela} WHERE cod_portais = '{$this->cod_portais}'");
            $db->ProximoRegistro();
    ...
    public function existe()
    {
        if (is_numeric($this->cod_portais)) {
            $db = new clsBanco();
            $db->Consulta("SELECT 1 FROM {$this->_tabela} WHERE cod_portais = '{$this->cod_portais}'");
            $db->ProximoRegistro();
    ...
    public function excluir()
    {
        ...
        /*
            delete
        $db = new clsBanco();
        $db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_portais = '{$this->cod_portais}'" );
        return true;
        */
