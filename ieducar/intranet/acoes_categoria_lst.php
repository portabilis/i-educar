...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Nome do categoria']);
        ...
        if ($Listacategorias) {
            foreach ($Listacategorias as $categoria) {
                $this->addLinhas(["<img src='imagens/noticia.jpg' border=0> <a href='acoes_categoria_det.php?cod_categoria={$categoria['cod_categoria']}'>{$categoria['nm_categoria']}</a>"]);
