...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
      ...
      'max_length'  => 4
        ...
        // tipos
        $tiposNacionalidade = ['1'  => 'Brasileira',
                                '2'  => 'Naturalizado brasileiro',
                                '3'  => 'Estrangeira'];

        $options            = ['label'       => 'Nacionalidade',
      ...
      'hiddenInputOptions' => $hiddenInputOptions
        ...
        $helperOptions = ['objectName'         => 'naturalidade',
    ...
    protected function addParentsInput($parentType, $parentTypeLabel = '')
    {
        ...
        $options            = ['label'      => 'Pessoa ' . $parentTypeLabel,
                                'size'       => 50,
                                'required'   => false,
    ...
    public function possuiDocumentoObrigatorio()
    {
