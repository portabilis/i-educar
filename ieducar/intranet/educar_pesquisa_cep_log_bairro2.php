  ...
  function Gerar()
  {
    ...
    foreach ($result as $record) {
      ...
      $url = sprintf(
        ...
        Session::get('campo1'), $bairro.' / Zona '. ($zona ? 'Urbana' : 'Rural'), Session::get('campo2'),
        $idbai, Session::get('campo3'), $cep,
        Session::get('campo4'), $descricao." ".$logradouro,
        Session::get('campo5'), $idlog,
        Session::get('campo6'), $iddis, Session::get('campo7'), $iddis. ' - '.$distrito,
        '', '', '', '',
        Session::get('campo10'), $cep2, Session::get('campo11'), $id_mun.' - '.$cidade.' ('.$uf.')',
