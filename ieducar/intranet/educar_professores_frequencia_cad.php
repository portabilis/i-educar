    ...
    public function Novo() {
        ...
        if (!$cadastrou) {
            ...
            //cadastra as informações no banco 
                    ...
                    $ComponenteId = $this->ref_cod_componente_curricular;
                        ...
                        if($etapa_curso_serie<6){
                            ...
                            $data = Frequencia::latest('id')->first();
                            $id_frequencia = $data->id;

                            $data_freq = FrequenciaInformacoes::latest('id')->first();
                            $id_frequencia_informacao = $data_freq->id+1;

                            FrequenciaInformacoes::create( [
                                ...
                                FrequenciaInformacoes::create( [
                                    ...
                                    'ref_frequencia' => $id_frequencia,
                                    'ch' => $carga_horaria,
                                    'aulas_realizadas' => $total,
                                    'aulas_realizar' => $aula_restante,
                                    'tipo_turma' => 2
