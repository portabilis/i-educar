...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		*/
		...
		$this->campoRadio("tipo_relatorio","Tipo Relat&oacute;rio",array('c' => 'Conceitual','p' => 'Padrão'),'p');
...
*/
		...
		//$this->campoCheck("avaliacao_globalizada","Avalia&ccedil;&atilde;o Globalizada",$this->avaliacao_globalizada);
		...
		if($this->get_link)
			$this->campoRotulo("rotulo11", "-", "<a href='$this->get_link' id='tt' target='_blank'>Baixar Relatório</a>");
...
function acao2()
{
	...
	showExpansivelImprimir(400, 200,'',[], "Diário de Classe - Avalia&ccedil;&otilde;es");
