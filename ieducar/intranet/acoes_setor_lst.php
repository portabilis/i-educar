...
class indice extends clsListagem
{
    public function Gerar()
    {
        ...
        $this->addCabecalhos([ 'Nome do setor']);
        ...
        if ($Listasetors) {
            foreach ($Listasetors as $setor) {
                ...
                $this->addLinhas(["<img src='imagens/noticia.jpg' border=0> <a href='acoes_setor_det.php?cod_setor={$setor['ref_cod_setor']}'>{$strNivel}</a>"]);
                $total = $setor['_total'];
            }
        }
        // Paginador
