...
class indice extends clsCadastro
{
    ...
    $this->campoCheck("permitir_carga_horaria", "Não permitir usar carga horária", $this->permitir_carga_horaria, NULL, false, false, false, 'Caso a opção estiver habilitda, não será possivel adicionar carga horária, na tablea de disciplinas adicionais do aluno.');
