...
class CoreExt_DataMapper_IntegrationTest extends IntegrationBaseTest
{
    ...
    {
        $expected = [
      new CoreExt_EntityStub(['id' => 1, 'nome' => 'Arnaldo Antunes']),
      new CoreExt_EntityStub(['id' => 2, 'nome' => 'Marvin Gaye'])
    ];
    ...
    public function testRecuperaRegistroUnico()
    {
        ...
        $expected = new CoreExt_EntityStub([
      'id' => 1,
    ...
    {
        $mapper = new CoreExt_EntityDataMapperStub($this->getDbAdapter());
        $found = $mapper->findAll([], ['estadoCivil' => 'solteiro']);
