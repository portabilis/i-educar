...
Route::group(['middleware' => ['ieducar.navigation', 'ieducar.footer', 'ieducar.xssbypass', 'ieducar.suspended', 'auth', 'ieducar.checkresetpassword']], function () {
    ...
    Route::get('/matricula/{registration}/enturmar/{schoolClass}', 'ManutencaoController@viewEnrollManutencao')
        ->name('manutencao.enrollmanutencao.create');
    Route::post('/matricula/{registration}/enturmar/{schoolClass}', 'ManutencaoController@enrollManutencao')
...
Route::group(['namespace' => 'Exports', 'prefix' => 'exports'], function () {
    ...
    Route::get('responsaveis_turma', 'ResponsavelTurmaController@export');
});
