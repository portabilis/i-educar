...
class Registro20 extends AbstractRegistro
{
    ...
    public function getRecordExportData($record)
    {
        ...
        return [
            ...
            $record->classeComLinguaBrasileiraSinais ?: 0 // 76 Classe com ensino desenvolvido com a Língua Brasileira de Sinais – Libras como primeira língua e a língua portuguesa de forma escrita
        ];
    }
