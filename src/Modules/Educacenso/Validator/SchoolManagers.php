...
class SchoolManagers implements EducacensoValidator
{
    ...
    private function validateAccessLinkType($valueObject)
    {
        ...
        if (empty($valueObject->linkTypeId) &&
            $this->operatingSituation == SituacaoFuncionamento::EM_ATIVIDADE
        ) {
            $this->valid = false;
            $this->message[] = 'O campo: <b>Tipo de vínculo</b> deve ser preenchido quando o campo: <b>Situação de funcionamento</b> for: <b>Em atividade</b> e o campo: <b>Dependência administrativa</b> não for: <b>Privada</b>';
        }
    }
