                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Agora você tem acesso ao i-Educar, a plataforma que automatiza os processos da
                                        educação, centraliza e gera dados em tempo real</p>
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Para fazer login no sistema utilize as informações abaixo:</p>
                                    <table class="action"
                                        ...
                                        <tr>
                                            <td>
                                                <table class="action" align="center" width="100%" cellpadding="0"
                                                       ...
                                                       style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: padding: 0; text-align: center; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                                    <tr>
                                                        <td align="center"
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <b>Usuário/Matrícula:</b> {{$username}}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center"
                                                                                    style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; text-align: left;">
                                                                                    <b>Senha:</b> {{$password}}</td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Você pode alterar sua senha para uma de sua preferência ao fazer login no
                                        sistema e em seguida ir em "Meus Dados" localizado no menu do topo
                                    </p>
                                    @if($url)
                                            ...
                                            <tr>
                                                <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box;">
                                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                        Se você tiver problemas ao clicar no botão "Ir ao i-Educar",
                                                        copie
                                                        e cole a URL abaixo em seu navegador: <a
                                                            href="{{$url}}"
