    ...
    public function getEmployeeDataForRecord30($arrayEmployeeId)
    {
        ...
        $sql = <<<SQL
            SELECT DISTINCT
                ...
                (ARRAY[20] <@ servidor.curso_formacao_continuada)::INT "formacaoContinuadaAlfabetizacao",
                (ARRAY[21] <@ servidor.curso_formacao_continuada)::INT "formacaoEducacaoEmTempoIntegral",
