...
class EducacensoRepository
{
    ...
    public function getDataForRecord00($school, $year)
    {
        $sql = <<<'SQL'
            ...
            e.qtd_edu_prof_quali_prof_inte_edu_eja_no_ensino_fund_par AS "qtdMatEducacaoProfissionalIntegradaEjaFundamentalParcial",
            e.qtd_edu_prof_quali_prof_inte_edu_eja_no_ensino_fund_int AS  "qtdMatEducacaoProfissionalIntegradaEjaFundamentalIntegral",
            e.qtd_edu_prof_quali_prof_tec_inte_edu_eja_nivel_med_par AS "qtdMatEducacaoProfissionalIntegradaEjaNivelMedioParcial",
            e.qtd_edu_prof_quali_prof_tec_inte_edu_eja_nivel_med_int AS "qtdMatEducacaoProfissionalIntegradaEjaNivelMedioIntegral",
            e.qtd_edu_prof_quali_prof_tec_conc_edu_eja_nivel_med_par AS "qtdMatEducacaoProfissionalConcomitanteEjaNivelMedioParcial",
            e.qtd_edu_prof_quali_prof_tec_conc_edu_eja_nivel_med_int AS "qtdMatEducacaoProfissionalConcomitanteEjaNivelMedioIntegral",
            e.qtd_edu_prof_quali_prof_tec_conc_inter_edu_eja_nivel_med_par AS "qtdMatEducacaoProfissionalIntercomentarEjaNivelMedioParcial",
            e.qtd_edu_prof_quali_prof_tec_conc_inter_edu_eja_nivel_med_int AS "qtdMatEducacaoProfissionalIntercomentarEjaNivelMedioIntegral",
            e.qtd_edu_prof_quali_prof_tec_inte_ensino_med_par AS "qtdMatEducacaoProfissionalIntegradaEnsinoMedioParcial",
            e.qtd_edu_prof_quali_prof_tecinte_ensino_med_int AS "qtdMatEducacaoProfissionalIntegradaEnsinoMedioIntegral",
            e.qtd_edu_prof_quali_prof_tec_conc_ensino_med_par AS "qtdMatEducacaoProfissionalConcomitenteEnsinoMedioParcial",
            e.qtd_edu_prof_quali_prof_tec_conc_ensino_med_int AS "qtdMatEducacaoProfissionalConcomitenteEnsinoMedioIntegral",
            e.qtd_edu_prof_quali_prof_tec_conc_inter_ensino_med_par AS "qtdMatEducacaoProfissionalIntercomplementarEnsinoMedioParcial",
            e.qtd_edu_prof_quali_prof_tec_conc_inter_ensino_med_int AS "qtdMatEducacaoProfissionalIntercomplementarEnsinoMedioIntegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_inte_ensino_med_par AS "qtdMatEducacaoProfissionalTecnicaIntegradaEnsinoMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_inte_ensino_med_int AS "qtdMatEducacaoProfissionalTecnicaIntegradaEnsinoMedioIntegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_ensino_med_par AS "qtdMatEducacaoProfissionalTecnicaConcomitanteEnsinoMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_ensino_med_int AS "qtdMatEducacaoProfissionalTecnicaConcomitanteEnsinoMedioIntegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_inter_ensino_med_par AS "qtdMatEducacaoProfissionalTecnicaIntercomplementarEnsinoMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_inter_ensino_med_int AS "qtdMatEducacaoProfissionalTecnicaIntercomplementarEnsinoMedioItegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_subsequente_ensino_med AS "qtdMatEducacaoProfissionalTecnicaSubsequenteEnsinoMedio",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_inte_edu_eja_nivel_med_par AS "qtdMatEducacaoProfissionalTecnicaIntegradaEjaNivelMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_inte_edu_eja_nivel_med_int AS "qtdMatEducacaoProfissionalTecnicaIntegradaEjaNivelMedioIntegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_edu_eja_nivel_med_par AS "qtdMatEducacaoProfissionalTecnicaConcomitanteEjaNivelMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_edu_eja_nivel_med_int AS "qtdMatEducacaoProfissionalTecnicaConcomitanteEjaNivelMedioIntegral",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_inter_edu_eja_med_par AS "qtdMatEducacaoProfissionalTecnicaIntercomplementarEjaNivelMedioParcial",
            e.qtd_edu_prof_edu_prof_tec_nivel_med_conc_inter_edu_eja_med_int AS "qtdMatEducacaoProfissionalTecnicaIntercomplementarEjaNivelMedioIntegral",
