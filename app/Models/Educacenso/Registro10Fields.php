...
class Registro10Fields implements RegistroEducacenso
{
    ...
    private $tratamentoLixoReaproveitamento;
    private $tratamentoLixoReciclagem;
    private $tratamentoLixoNaoFaz;
    private $dependenciaBanheiro;
    private $dependenciaBanheiroFuncionarios;
    private $dependenciaDormitorioAluno;
    private $dependenciaDormitorioProfessor;
    private $dependenciaPiscina;
    private $dependenciaSalaRepouso;
    private $dependenciaSalaArtes;
    private $dependenciaSalaMusica;
    private $dependenciaSalaDanca;
    private $dependenciaSalaMultiuso;
    private $dependenciaTerreirao;
    private $dependenciaViveiro;
    private $dependenciaSalaSecretaria;
    private $recursoCorrimao;
    private $recursoElevador;
    private $recursoPisosTateis;
    private $recursoPortaVaoLivre;
    private $recursoRampas;
    private $recursoSinalizacaoSonora;
    private $recursoSinalizacaoTatil;
    private $recursoSinalizacaoVisual;
    private $recursoNenhum;
    private $equipamentosScanner;
    private $acessoInternetAdministrativo;
    private $acessoInternetProcessoEnsino;
    private $acessoInternetAlunos;
    private $acessoInternetComunidade;
    private $acessoInternetNaoPossui;
    private $computadoresMesaAcessoInternet;
    private $dispositovosPessoaisAcessoInternet;
    private $internetBandaLarga;
    private $redeLocalCabo;
    private $redeLocalWireless;
    private $redeLocalNaoExiste;
    private $organizacaoEnsinoSerieAno;
    private $organizacaoEnsinoPeriodosSemestrais;
    private $organizacaoEnsinoGrupos;
    private $organizacaoEnsinoCiclos;
    private $organizacaoEnsinoModulos;
    private $organizacaoEnsinoAlternancia;
    private $instrumentosPedagogicosAcervo;
    private $instrumentosPedagogicosBrinquedos;
    private $instrumentosPedagogicosMateriaisCientificos;
    private $instrumentosPedagogicosEquipamentosSom;
    private $instrumentosPedagogicosInstrumentos;
    private $instrumentosPedagogicosJogos;
    private $instrumentosPedagogicosAtividadesCulturais;
    private $instrumentosPedagogicosPraticaDesportiva;
    private $instrumentosPedagogicosEducacaoIndigena;
    private $instrumentosPedagogicosEducacaoEtnicoRacial;
    private $numeroSalasClimatizadasEducacaoCampo;
    private $linguaIndigena;
    private $linguaPortuguesa;
    private $linguaIndigena1;
    private $linguaIndigena2;
    private $linguaIndigena3;
    private $reservaVagasCotasAutodeclaracao;
    private $reservaVagasCotasRenda;
    private $reservaVagasCotasEscolaPublica;
    private $reservaVagasCotasPCD;
    private $reservaVagasCotasOutros;
    private $reservaVagasCotasNaoFaz;
    private $orgaoColegiadoAssociacaoPais;
    private $orgaoColegiadoAssociacaoPaisMestres;
    private $orgaoColegiadoConselho;
    private $orgaoColegiadoGremio;
    private $orgaoColegiadoNaoOutros;
    private $orgaoColegiadoNaoExiste;
    ...
    public function hydrateModel($arrayColumns)
    {
        ...
        $this->codigoInepEscolaCompartilhada = $arrayColumns[10];
        ...
        $this->numeroSalasClimatizadasEducacaoCampo = $arrayColumns[143];
        ...
        $this->orgaoColegiadoNaoOutros = $arrayColumns[164];
