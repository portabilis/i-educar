...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Registro de Avaliação - Anos Iniciais" );
		$this->processoAp = "999501";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_registro_avaliacao_anos_iniciais.jrxml");
