...
class PortabilisRelacaoAlunosMatriculados extends Report
{
  function setForm()
  {
    ...
    $opcoes[4] = "Transferido";
		...
		$this->campoLista('situacao', 'Situaчуo', $opcoes, $this->situacao, 6);
...
$report = new PortabilisRelacaoAlunosMatriculados($name = 'Relaчуo de Alunos Matriculados por Escola', $templateName = 'portabilis_alunos_matriculados_por_escola');
