...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Boletim Escolar - Parecer Desc. (Geral)" );
		$this->processoAp = "999224";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_boletim_parecer_geral.jrxml");
