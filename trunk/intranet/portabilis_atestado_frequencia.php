...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		//campo adicionado para pegar por parametro o período inicial
		$this->campoData("periodo_inicial","Período inicial:",$this->periodo_inicial,false);
		
		//campo adicionado para pegar por parametro o período final
		$this->campoData("periodo_final","Período final:",$this->periodo_final,false);
		
		//campo adicionado para pegar por parametro a data validade do Atestado de Vaga
		$this->campoData("data_validade","Validade do documento:",$this->data_validade,false);
...
document.formcadastro.action = 'portabilis_atestado_frequencia_proc.php';
