...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Alunos Matriculados por Escola" );
		$this->processoAp = "999105";
...
//	var $ref_cod_matricula;
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_alunos_matriculados_por_escola.jrxml");
