...
class PortabilisBoletimParecerDescritivo extends Report
{
  function setForm()
  {
...
$report = new PortabilisBoletimParecerDescritivo($name = 'Boletim Escolar - Parecer Descritivo', $templateName = 'portabilis_boletim_parecer');
