...
$report = new PortabilisRelacaoAlunosNaoEnturmados($name = 'Relação de Alunos não Enturmados por Escola', $templateName = 'portabilis_alunos_nao_enturmados_por_escola');
