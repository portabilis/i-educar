...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Movimento de Alunos" );
...
//	var $ref_cod_matricula;
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_movimento_alunos.jrxml");
...
*/
	...
	$PHPJasperXML->arrayParameter=array("ano"=>$_POST['ano'] ,"instituicao"=>$_POST['ref_cod_instituicao'],"escola"=>$_POST['ref_cod_escola'],"curso"=>$_POST['ref_cod_curso'],"data_inicial"=>"'".$_POST['data_inicial']."'","data_final"=>"'".$_POST['data_final']."'"); 
