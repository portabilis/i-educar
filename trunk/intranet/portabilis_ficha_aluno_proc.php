...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Ficha de Aluno" );
		$this->processoAp = "999203";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_ficha_aluno.jrxml");
...
*/
	...
	$PHPJasperXML->arrayParameter=array("instituicao"=>$_POST['ref_cod_instituicao'],"aluno"=>$_POST['ref_cod_aluno'],"escola"=>$_POST['ref_cod_escola']); 
