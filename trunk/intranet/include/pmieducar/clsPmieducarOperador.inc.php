...
class clsPmieducarOperador
{
	 ...
	 * @return object
	 */
	function clsPmieducarOperador( $cod_operador = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nome = null, $valor = null, $fim_sentenca = null, $data_cadastro = null, $data_exclusao = null, $ativo = null )
	{
		$db = new clsBanco();
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE cod_operador = '{$this->cod_operador}'" );
		return true;
		*/
