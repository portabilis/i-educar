...
class clsPmieducarDisciplinaDisciplinaTopico
{
	...
	var $ref_ref_ref_cod_escola;
	var $ref_ref_ref_cod_serie;
	var $ref_cod_disciplina_topico;
	 ...
	 * @return object
	 */
	function clsPmieducarDisciplinaDisciplinaTopico( $ref_ref_cod_disciplina = null, $ref_ref_ref_cod_escola = null, $ref_ref_ref_cod_serie = null, $ref_cod_disciplina_topico = null )
	{
		$db = new clsBanco();
	 ...
	 * @return array
	 */
	function lista( $int_ref_ref_cod_disciplina = null, $int_ref_ref_ref_cod_escola = null, $int_ref_ref_ref_cod_serie = null, $int_ref_cod_disciplina_topico = null )
	{
	...
	function excluir()
	{
		...
		/*
			delete
		$db = new clsBanco();
		$db->Consulta( "DELETE FROM {$this->_tabela} WHERE ref_ref_cod_disciplina = '{$this->ref_ref_cod_disciplina}' AND ref_ref_ref_cod_escola = '{$this->ref_ref_ref_cod_escola}' AND ref_ref_ref_cod_serie = '{$this->ref_ref_ref_cod_serie}' AND ref_cod_disciplina_topico = '{$this->ref_cod_disciplina_topico}'" );
		return true;
		*/
