...
class PortabilisCarteiraEstudante extends Report
{
  function setForm()
  {
...
$report = new PortabilisCarteiraEstudante($name = 'Carteira de Estudante', $templateName = 'portabilis_carteira_estudante');
