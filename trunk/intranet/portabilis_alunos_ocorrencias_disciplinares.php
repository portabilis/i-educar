...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Relação de Ocorrências Disciplinares por Aluno" );
...
document.formcadastro.action = 'portabilis_alunos_ocorrencias_disciplinares_proc.php';
