...
$report = new PortabilisRelacaoAlunosTranporteEscolar($name = 'Relação de Alunos Transporte Escolar', $templateName = 'portabilis_relacao_alunos_transporte_escolar_grafico');
