...
class PortabilisBoletimBimestralPacaja extends Report
{
  function setForm()
  {
...
$report = new PortabilisBoletimBimestralPacaja($name = 'Boletim Escolar - Bimestral', $templateName = 'portabilis_boletim_bimestral_pacaja');
