...
class PortabilisFichaIndividual extends Report
{
  function setForm()
  {
...
$report = new PortabilisFichaIndividual($name = 'Ficha Individual', $templateName = 'portabilis_ficha_individual_pacaja');
