...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Registro de Frequência - Anos Finais" );
		$this->processoAp = "999504";
	}
}
...
document.formcadastro.action = 'portabilis_registro_frequencia_anos_finais_proc.php';
