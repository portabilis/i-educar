...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Registro de Frequência - Anos Iniciais" );
		$this->processoAp = "999503";
	}
}
...
/* Essa parte é que traz o aluno, depois da turma, no caso a listagem de alunos
...
document.formcadastro.action = 'portabilis_registro_frequencia_anos_iniciais_proc.php';
