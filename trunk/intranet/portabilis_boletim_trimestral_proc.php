...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Boletim Escolar - Trimestral" );
		$this->processoAp = "999218";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_boletim_trimestral.jrxml");
