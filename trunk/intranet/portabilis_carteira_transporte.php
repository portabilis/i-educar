...
class PortabilisCarteiraTransporte extends Report
{
  function setForm()
  {
...
$report = new PortabilisCarteiraTransporte($name = 'Carteira de Transporte', $templateName = 'portabilis_carteira_transporte');
