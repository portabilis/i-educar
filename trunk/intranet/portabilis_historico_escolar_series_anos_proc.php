...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Histórico Escolar (Série/Anos)" );
		$this->processoAp = "999220";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_historico_escolar_series_anos.jrxml");
...
*/
	...
	$PHPJasperXML->arrayParameter=array("instituicao"=>$_POST['ref_cod_instituicao'],"escola"=>$_POST['ref_cod_escola'],"aluno"=>$_POST['ref_cod_aluno']); 
