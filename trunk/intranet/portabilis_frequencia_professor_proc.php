...
//	var $ref_cod_matricula;
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_frequencia_professor.jrxml");
...
*/
	...
	$PHPJasperXML->arrayParameter=array("ano"=>$_POST['ano'] ,"instituicao"=>$_POST['ref_cod_instituicao'],"escola"=>$_POST['ref_cod_escola'],"data_inicio"=>"'".$_POST['data_inicio']."'","data_fim"=>"'".$_POST['data_fim']."'"); 
