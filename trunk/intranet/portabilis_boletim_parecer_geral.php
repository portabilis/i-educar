...
class PortabilisBoletimParecerDescritivoGeral extends Report
{
  function setForm()
  {
...
$report = new PortabilisBoletimParecerDescritivoGeral($name = 'Boletim Escolar - Parecer Descritivo (Geral)', $templateName = 'portabilis_boletim_parecer_geral');
