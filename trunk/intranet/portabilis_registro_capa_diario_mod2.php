...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Registro Capa Diário de Classe (Modelo 2)" );
...
document.formcadastro.action = 'portabilis_registro_capa_diario_mod2_proc.php';
