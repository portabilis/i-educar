...
class PortabilisRegistroDiarioClasseCapaMod2 extends Report
{
  function setForm()
  {
...
$report = new PortabilisRegistroDiarioClasseCapaMod2($name = 'Diário de Classe - Capa (Modelo 2)', $templateName = 'portabilis_registro_capa_diario_mod2');
