...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - i-Educar - Relação de  Escolas" );
		$this->processoAp = "999605";
...
class indice extends clsCadastro
{
  ...
  var $aux_cod_escola;
	...
	function renderHTML()
	{
			...
			$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_relacao_escolas.jrxml");
      
      if (! isset($_POST['ref_cod_escola']) || ! $_POST['ref_cod_escola']) {
        $aux_cod_escola = 0;
      }
      else{
