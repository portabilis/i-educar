...
if (isset($_GET['somente_funcao_professor']) && $_GET['somente_funcao_professor'] == 'true')
{
  ...
  $componentesCurriculares = $professor->getComponentesCurriculares($instituicao = $_GET['instituicao_id'], $cursoId = $_GET['curso_id'], $escolaId = $_GET['escola_id'], $turmaId = $_GET['turma_id'], $anoEscolar = $_GET['ano_escolar']);
}  
else
