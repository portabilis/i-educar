...
class PortabilisBoletimSemestral extends Report
{
  function setForm()
  {
...
$report = new PortabilisBoletimSemestral($name = 'Boletim Escolar - Semestral', $templateName = 'portabilis_boletim_semestral');
