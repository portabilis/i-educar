...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		$this->campoNumero( "ano", "Ano", $this->ano ? $this->ano : date("Y"), 4, 4, true );
		$this->campoLista( "mes", "M&ecirc;s",$this->meses_do_ano, $this->mes,"",false );
		$this->campoRadio("tipo","Tipo Relatório",array('pb' => 'Primeiro Ano B&aacute;sico', 'pr' => 'Primeiro Ano Regular', 'se' => 'Segunda S&eacute;rie'),'pb');
...
function acao2()
{
	...
	if(document.formcadastro.tipo[0].checked) 
		document.formcadastro.action = 'educar_relatorio_ficha_leitura3_proc.php';
	else if(document.formcadastro.tipo[1].checked)
		document.formcadastro.action = 'educar_relatorio_ficha_leitura_proc.php'; 
	else
		document.formcadastro.action = 'educar_relatorio_ficha_leitura2_proc.php';
