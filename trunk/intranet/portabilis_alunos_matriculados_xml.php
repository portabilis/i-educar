...
if ($user->isLoggedIn())
{
  ...
  foreach ($records as $r) {
    ...
    //$nome = Portabilis_String_Utils::toLatin1($r['nome'], array('transform' => true, 'escape' => false, 'convert_html_special_chars' => true));

    $nome = Portabilis_String_Utils::toUtf8($r['nome'], array('transform' => true, 'convert_html_special_chars' => true));
