...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Atestado de Frequência" );
		$this->processoAp = "999102";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_atestado_frequencia.jrxml");
...
/*
	...
	*/
	...
	$PHPJasperXML->arrayParameter=array("ano"=>$_POST['ano'],"instituicao"=>$_POST['ref_cod_instituicao'],"escola"=>$_POST['ref_cod_escola'],"curso"=>$_POST['ref_cod_curso'],"serie"=>$_POST['ref_ref_cod_serie'],"turma"=>$_POST['ref_cod_turma'],"aluno"=>$_POST['ref_cod_matricula'],"periodo_inicial"=>$_POST['periodo_inicial'],"periodo_final"=>$_POST['periodo_final'],"data_validade"=>$_POST['data_validade']); 
