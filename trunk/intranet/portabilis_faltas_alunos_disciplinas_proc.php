...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Faltas dos Alunos por Disciplina" );
		$this->processoAp = "999106";
...
class indice extends clsCadastro
{
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_faltas_alunos_disciplinas.jrxml");
