...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Ocorrências Disciplinares por Aluno" );
...
//	var $ref_cod_matricula;
	...
	$xml =  simplexml_load_file("relatorios/jasperreports/portabilis_alunos_ocorrencias_disciplinares.jrxml");
